...
// Code created using PandA - Version: PandA 0.9.6 - Revision 891ec3caed502474cab0813cc4a9fc678deabaa5 - Date 2022-05-30T17:22:38
// bambu executed with: bambu -I/home/dews/Scrivania/bambu-hls/RESULTS/BAMBU/xc7a100t-1csg324-Artix-7/28x28/straight_sort_TODO/includes/values_91 --simulate --simulator=VERILATOR --clock-period=5 --device-name=xc7a100t-1csg324-VVD /home/dews/Scrivania/bambu-hls/cc4cs_bambu/benchmarkBasic/straight_sort/thrd.c 
// 
...
module datapath_straight_sort(clock, reset, in_port_size, in_port_arr, M_Rdata_ram, M_DataRdy, Min_oe_ram, Min_we_ram, Min_addr_ram, Min_Wdata_ram, Min_data_ram_size, Mout_oe_ram, Mout_we_ram, Mout_addr_ram, Mout_Wdata_ram, Mout_data_ram_size, fuselector_BMEMORY_CTRLN_20_i0_LOAD, fuselector_BMEMORY_CTRLN_20_i0_STORE, fuselector_BMEMORY_CTRLN_20_i1_LOAD, fuselector_BMEMORY_CTRLN_20_i1_STORE, selector_MUX_0_BMEMORY_CTRLN_20_i0_0_0_0, selector_MUX_1_BMEMORY_CTRLN_20_i0_1_0_0, selector_MUX_1_BMEMORY_CTRLN_20_i0_1_0_1, selector_MUX_1_BMEMORY_CTRLN_20_i0_1_1_0, selector_MUX_22_reg_1_0_0_0, selector_MUX_23_reg_10_0_0_0, selector_MUX_27_reg_14_0_0_0, selector_MUX_33_reg_7_0_0_0, selector_MUX_34_reg_8_0_0_0, wrenable_reg_0, wrenable_reg_1, wrenable_reg_10, wrenable_reg_11, wrenable_reg_12, wrenable_reg_13, wrenable_reg_14, wrenable_reg_2, wrenable_reg_3, wrenable_reg_4, wrenable_reg_5, wrenable_reg_6, wrenable_reg_7, wrenable_reg_8, wrenable_reg_9, OUT_CONDITION_straight_sort_28861_29039, OUT_CONDITION_straight_sort_28861_29041, OUT_CONDITION_straight_sort_28861_29043);
  ...
  MUX_GATE #(.BITSIZE_in1(32), .BITSIZE_in2(32), .BITSIZE_out1(32)) MUX_23_reg_10_0_0_0 (.out1(out_MUX_23_reg_10_0_0_0), .sel(selector_MUX_23_reg_10_0_0_0), .in1(out_conv_out_UUdata_converter_FU_15_i0_fu_straight_sort_28861_28982_8_32), .in2(out_u_assign_conn_obj_2_ASSIGN_UNSIGNED_FU_u_assign_4));
  ...
  MUX_GATE #(.BITSIZE_in1(8), .BITSIZE_in2(8), .BITSIZE_out1(8)) MUX_34_reg_8_0_0_0 (.out1(out_MUX_34_reg_8_0_0_0), .sel(selector_MUX_34_reg_8_0_0_0), .in1(out_reg_11_reg_11), .in2(out_UUdata_converter_FU_7_i0_fu_straight_sort_28861_28996));
  ...
  ui_plus_expr_FU #(.BITSIZE_in1(8), .BITSIZE_in2(1), .BITSIZE_out1(8)) fu_straight_sort_28861_28962 (.out1(out_ui_plus_expr_FU_8_0_8_25_i0_fu_straight_sort_28861_28962), .in1(out_reg_10_reg_10), .in2(out_const_2));
  ui_plus_expr_FU #(.BITSIZE_in1(32), .BITSIZE_in2(1), .BITSIZE_out1(32)) fu_straight_sort_28861_28979 (.out1(out_ui_plus_expr_FU_32_0_32_24_i0_fu_straight_sort_28861_28979), .in1(out_reg_1_reg_1), .in2(out_const_2));
  ...
  ui_plus_expr_FU #(.BITSIZE_in1(8), .BITSIZE_in2(8), .BITSIZE_out1(8)) fu_straight_sort_28861_28986 (.out1(out_ui_plus_expr_FU_8_0_8_26_i0_fu_straight_sort_28861_28986), .in1(out_reg_8_reg_8), .in2(out_const_4));
  UUdata_converter_FU #(.BITSIZE_in1(32), .BITSIZE_out1(8)) fu_straight_sort_28861_28996 (.out1(out_UUdata_converter_FU_7_i0_fu_straight_sort_28861_28996), .in1(out_reg_1_reg_1));
  ...
  ui_plus_expr_FU #(.BITSIZE_in1(8), .BITSIZE_in2(1), .BITSIZE_out1(8)) fu_straight_sort_28861_29015 (.out1(out_ui_plus_expr_FU_8_0_8_25_i1_fu_straight_sort_28861_29015), .in1(out_reg_14_reg_14), .in2(out_const_2));
  read_cond_FU #(.BITSIZE_in1(1)) fu_straight_sort_28861_29039 (.out1(out_read_cond_FU_8_i0_fu_straight_sort_28861_29039), .in1(out_lt_expr_FU_8_8_8_21_i0_lt_expr_FU_8_8_8_21_i0));
  ...
  read_cond_FU #(.BITSIZE_in1(1)) fu_straight_sort_28861_29043 (.out1(out_read_cond_FU_19_i0_fu_straight_sort_28861_29043), .in1(out_reg_6_reg_6));
  ui_plus_expr_FU #(.BITSIZE_in1(1), .BITSIZE_in2(32), .BITSIZE_out1(8)) fu_straight_sort_28861_29080 (.out1(out_ui_plus_expr_FU_0_8_8_23_i0_fu_straight_sort_28861_29080), .in1(out_const_2), .in2(out_reg_1_reg_1));
  ...
  ui_pointer_plus_expr_FU #(.BITSIZE_in1(32), .BITSIZE_in2(32), .BITSIZE_out1(7), .LSB_PARAMETER(0)) fu_straight_sort_28861_29087 (.out1(out_ui_pointer_plus_expr_FU_8_8_8_27_i4_fu_straight_sort_28861_29087), .in1(in_port_arr), .in2(out_reg_1_reg_1));
  lt_expr_FU #(.BITSIZE_in1(8), .BITSIZE_in2(8), .BITSIZE_out1(1)) fu_straight_sort_28861_29096 (.out1(out_lt_expr_FU_8_8_8_21_i1_fu_straight_sort_28861_29096), .in1(out_reg_0_reg_0), .in2(out_reg_13_reg_13));
  ...
  register_SE #(.BITSIZE_in1(8), .BITSIZE_out1(8)) reg_11 (.out1(out_reg_11_reg_11), .clock(clock), .reset(reset), .in1(out_ui_plus_expr_FU_8_0_8_26_i0_fu_straight_sort_28861_28986), .wenable(wrenable_reg_11));
  register_SE #(.BITSIZE_in1(7), .BITSIZE_out1(7)) reg_12 (.out1(out_reg_12_reg_12), .clock(clock), .reset(reset), .in1(out_ui_pointer_plus_expr_FU_8_8_8_27_i1_fu_straight_sort_28861_29008), .wenable(wrenable_reg_12));
  ...
  register_SE #(.BITSIZE_in1(7), .BITSIZE_out1(7)) reg_2 (.out1(out_reg_2_reg_2), .clock(clock), .reset(reset), .in1(out_ui_pointer_plus_expr_FU_8_8_8_27_i2_fu_straight_sort_28861_29012), .wenable(wrenable_reg_2));
  register_SE #(.BITSIZE_in1(32), .BITSIZE_out1(32)) reg_3 (.out1(out_reg_3_reg_3), .clock(clock), .reset(reset), .in1(out_ui_plus_expr_FU_32_0_32_24_i0_fu_straight_sort_28861_28979), .wenable(wrenable_reg_3));
  register_SE #(.BITSIZE_in1(7), .BITSIZE_out1(7)) reg_4 (.out1(out_reg_4_reg_4), .clock(clock), .reset(reset), .in1(out_ui_pointer_plus_expr_FU_8_8_8_27_i3_fu_straight_sort_28861_29083), .wenable(wrenable_reg_4));
  register_SE #(.BITSIZE_in1(7), .BITSIZE_out1(7)) reg_5 (.out1(out_reg_5_reg_5), .clock(clock), .reset(reset), .in1(out_ui_pointer_plus_expr_FU_8_8_8_27_i4_fu_straight_sort_28861_29087), .wenable(wrenable_reg_5));
  register_SE #(.BITSIZE_in1(1), .BITSIZE_out1(1)) reg_6 (.out1(out_reg_6_reg_6), .clock(clock), .reset(reset), .in1(out_ui_ne_expr_FU_32_0_32_22_i0_fu_straight_sort_28861_29098), .wenable(wrenable_reg_6));
  ...
  register_STD #(.BITSIZE_in1(7), .BITSIZE_out1(7)) reg_9 (.out1(out_reg_9_reg_9), .clock(clock), .reset(reset), .in1(out_ui_pointer_plus_expr_FU_8_8_8_27_i0_fu_straight_sort_28861_28957), .wenable(wrenable_reg_9));
    ...
    case (_present_state)
      ...
      S_11 :
        begin
          ...
          wrenable_reg_1 = 1'b1;
          wrenable_reg_2 = 1'b1;
          if (OUT_CONDITION_straight_sort_28861_29043 == 1'b0)
            begin
              _next_state = S_1;
              done_port = 1'b1;
              selector_MUX_22_reg_1_0_0_0 = 1'b0;
