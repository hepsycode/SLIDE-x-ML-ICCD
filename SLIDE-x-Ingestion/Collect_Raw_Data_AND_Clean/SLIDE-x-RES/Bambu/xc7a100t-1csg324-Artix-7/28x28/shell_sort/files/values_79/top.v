...
// Code created using PandA - Version: PandA 0.9.6 - Revision 891ec3caed502474cab0813cc4a9fc678deabaa5 - Date 2022-05-30T17:01:05
// bambu executed with: bambu -I/home/dews/Scrivania/bambu-hls/RESULTS/BAMBU/xc7a100t-1csg324-Artix-7/28x28/shell_sort_TODO/includes/values_79 --simulate --simulator=VERILATOR --clock-period=5 --device-name=xc7a100t-1csg324-VVD /home/dews/Scrivania/bambu-hls/cc4cs_bambu/benchmarkBasic/shell_sort/thrd.c 
// 
...
module datapath_shell_sort(clock, reset, in_port_size, in_port_arr, M_Rdata_ram, M_DataRdy, Min_oe_ram, Min_we_ram, Min_addr_ram, Min_Wdata_ram, Min_data_ram_size, Mout_oe_ram, Mout_we_ram, Mout_addr_ram, Mout_Wdata_ram, Mout_data_ram_size, fuselector_BMEMORY_CTRLN_28_i0_LOAD, fuselector_BMEMORY_CTRLN_28_i0_STORE, selector_MUX_0_BMEMORY_CTRLN_28_i0_0_0_0, selector_MUX_141_reg_1_0_0_0, selector_MUX_160_reg_27_0_0_0, selector_MUX_163_reg_3_0_0_0, selector_MUX_171_reg_37_0_0_0, selector_MUX_1_BMEMORY_CTRLN_28_i0_1_0_0, selector_MUX_1_BMEMORY_CTRLN_28_i0_1_0_1, selector_MUX_1_BMEMORY_CTRLN_28_i0_1_1_0, wrenable_reg_0, wrenable_reg_1, wrenable_reg_10, wrenable_reg_11, wrenable_reg_12, wrenable_reg_13, wrenable_reg_14, wrenable_reg_15, wrenable_reg_16, wrenable_reg_17, wrenable_reg_18, wrenable_reg_19, wrenable_reg_2, wrenable_reg_20, wrenable_reg_21, wrenable_reg_22, wrenable_reg_23, wrenable_reg_24, wrenable_reg_25, wrenable_reg_26, wrenable_reg_27, wrenable_reg_28, wrenable_reg_29, wrenable_reg_3, wrenable_reg_30, wrenable_reg_31, wrenable_reg_32, wrenable_reg_33, wrenable_reg_34, wrenable_reg_35, wrenable_reg_36, wrenable_reg_37, wrenable_reg_38, wrenable_reg_4, wrenable_reg_5, wrenable_reg_6, wrenable_reg_7, wrenable_reg_8, wrenable_reg_9, OUT_CONDITION_shell_sort_28861_28960, OUT_CONDITION_shell_sort_28861_28979, OUT_CONDITION_shell_sort_28861_29076, OUT_CONDITION_shell_sort_28861_29079, OUT_CONDITION_shell_sort_28861_29083, OUT_CONDITION_shell_sort_28861_29085);
  ...
  MUX_GATE #(.BITSIZE_in1(8), .BITSIZE_in2(8), .BITSIZE_out1(8)) MUX_160_reg_27_0_0_0 (.out1(out_MUX_160_reg_27_0_0_0), .sel(selector_MUX_160_reg_27_0_0_0), .in1(out_reg_28_reg_28), .in2(out_IUconvert_expr_FU_6_i0_fu_shell_sort_28861_28978));
  ...
  ternary_mp_expr_FU #(.BITSIZE_in1(32), .BITSIZE_in2(32), .BITSIZE_in3(2), .BITSIZE_out1(31)) fu_shell_sort_28861_28977 (.out1(out_ternary_mp_expr_FU_32_32_0_32_60_i0_fu_shell_sort_28861_28977), .in1(out_reg_22_reg_22), .in2(out_reg_4_reg_4), .in3(out_const_0));
  ...
  read_cond_FU #(.BITSIZE_in1(1)) fu_shell_sort_28861_28979 (.out1(out_read_cond_FU_8_i0_fu_shell_sort_28861_28979), .in1(out_reg_25_reg_25));
  ...
  UUdata_converter_FU #(.BITSIZE_in1(8), .BITSIZE_out1(8)) fu_shell_sort_28861_29006 (.out1(out_UUdata_converter_FU_22_i0_fu_shell_sort_28861_29006), .in1(out_reg_37_reg_37));
  ui_plus_expr_FU #(.BITSIZE_in1(8), .BITSIZE_in2(1), .BITSIZE_out1(8)) fu_shell_sort_28861_29023 (.out1(out_ui_plus_expr_FU_8_0_8_65_i0_fu_shell_sort_28861_29023), .in1(out_reg_27_reg_27), .in2(out_const_12));
  ui_minus_expr_FU #(.BITSIZE_in1(8), .BITSIZE_in2(8), .BITSIZE_out1(8)) fu_shell_sort_28861_29026 (.out1(out_ui_minus_expr_FU_8_8_8_63_i0_fu_shell_sort_28861_29026), .in1(out_reg_37_reg_37), .in2(out_reg_24_reg_24));
  ...
  minus_expr_FU #(.BITSIZE_in1(9), .BITSIZE_in2(31), .BITSIZE_out1(31)) fu_shell_sort_28861_29043 (.out1(out_minus_expr_FU_32_32_32_46_i0_fu_shell_sort_28861_29043), .in1(out_UIdata_converter_FU_20_i0_fu_shell_sort_28861_29048), .in2(out_reg_23_reg_23));
  UIdata_converter_FU #(.BITSIZE_in1(8), .BITSIZE_out1(9)) fu_shell_sort_28861_29048 (.out1(out_UIdata_converter_FU_20_i0_fu_shell_sort_28861_29048), .in1(out_reg_37_reg_37));
  ...
  UUdata_converter_FU #(.BITSIZE_in1(8), .BITSIZE_out1(8)) fu_shell_sort_28861_29057 (.out1(out_UUdata_converter_FU_26_i0_fu_shell_sort_28861_29057), .in1(out_reg_37_reg_37));
  ...
  UUdata_converter_FU #(.BITSIZE_in1(8), .BITSIZE_out1(8)) fu_shell_sort_28861_29068 (.out1(out_UUdata_converter_FU_14_i0_fu_shell_sort_28861_29068), .in1(out_reg_27_reg_27));
  read_cond_FU #(.BITSIZE_in1(1)) fu_shell_sort_28861_29076 (.out1(out_read_cond_FU_10_i0_fu_shell_sort_28861_29076), .in1(out_reg_26_reg_26));
  ...
  read_cond_FU #(.BITSIZE_in1(1)) fu_shell_sort_28861_29079 (.out1(out_read_cond_FU_16_i0_fu_shell_sort_28861_29079), .in1(out_reg_35_reg_35));
  ...
  read_cond_FU #(.BITSIZE_in1(1)) fu_shell_sort_28861_29085 (.out1(out_read_cond_FU_27_i0_fu_shell_sort_28861_29085), .in1(out_reg_30_reg_30));
  ...
  bit_ior_concat_expr_FU #(.BITSIZE_in1(32), .BITSIZE_in2(2), .BITSIZE_in3(2), .BITSIZE_out1(32), .OFFSET_PARAMETER(1)) fu_shell_sort_28861_29138 (.out1(out_bit_ior_concat_expr_FU_35_i1_fu_shell_sort_28861_29138), .in1(out_lshift_expr_FU_32_0_32_41_i4_fu_shell_sort_28861_29280), .in2(out_reg_18_reg_18), .in3(out_const_0));
  ...
  plus_expr_FU #(.BITSIZE_in1(17), .BITSIZE_in2(32), .BITSIZE_out1(32)) fu_shell_sort_28861_29151 (.out1(out_plus_expr_FU_32_32_32_51_i0_fu_shell_sort_28861_29151), .in1(out_reg_19_reg_19), .in2(out_reg_16_reg_16));
  rshift_expr_FU #(.BITSIZE_in1(32), .BITSIZE_in2(6), .BITSIZE_out1(16), .PRECISION(32)) fu_shell_sort_28861_29154 (.out1(out_rshift_expr_FU_32_0_32_54_i3_fu_shell_sort_28861_29154), .in1(out_plus_expr_FU_32_32_32_51_i0_fu_shell_sort_28861_29151), .in2(out_const_4));
  ternary_plus_expr_FU #(.BITSIZE_in1(16), .BITSIZE_in2(16), .BITSIZE_in3(32), .BITSIZE_out1(32)) fu_shell_sort_28861_29163 (.out1(out_ternary_plus_expr_FU_32_32_32_32_61_i0_fu_shell_sort_28861_29163), .in1(out_reg_21_reg_21), .in2(out_reg_20_reg_20), .in3(out_reg_11_reg_11));
  ...
  bit_ior_concat_expr_FU #(.BITSIZE_in1(25), .BITSIZE_in2(5), .BITSIZE_in3(4), .BITSIZE_out1(25), .OFFSET_PARAMETER(4)) fu_shell_sort_28861_29182 (.out1(out_bit_ior_concat_expr_FU_37_i0_fu_shell_sort_28861_29182), .in1(out_lshift_expr_FU_32_0_32_43_i2_fu_shell_sort_28861_29321), .in2(out_reg_7_reg_7), .in3(out_const_2));
  ...
  bit_ior_concat_expr_FU #(.BITSIZE_in1(32), .BITSIZE_in2(9), .BITSIZE_in3(5), .BITSIZE_out1(32), .OFFSET_PARAMETER(8)) fu_shell_sort_28861_29189 (.out1(out_bit_ior_concat_expr_FU_38_i0_fu_shell_sort_28861_29189), .in1(out_lshift_expr_FU_32_0_32_44_i2_fu_shell_sort_28861_29342), .in2(out_reg_15_reg_15), .in3(out_const_3));
  ...
  bit_ior_concat_expr_FU #(.BITSIZE_in1(32), .BITSIZE_in2(9), .BITSIZE_in3(5), .BITSIZE_out1(32), .OFFSET_PARAMETER(8)) fu_shell_sort_28861_29207 (.out1(out_bit_ior_concat_expr_FU_38_i1_fu_shell_sort_28861_29207), .in1(out_lshift_expr_FU_32_0_32_44_i3_fu_shell_sort_28861_29393), .in2(out_reg_10_reg_10), .in3(out_const_3));
  ...
  gt_expr_FU #(.BITSIZE_in1(31), .BITSIZE_in2(9), .BITSIZE_out1(1)) fu_shell_sort_28861_29217 (.out1(out_gt_expr_FU_32_32_32_39_i0_fu_shell_sort_28861_29217), .in1(out_reg_23_reg_23), .in2(out_UIdata_converter_FU_23_i0_fu_shell_sort_28861_29078));
  lt_expr_FU #(.BITSIZE_in1(8), .BITSIZE_in2(8), .BITSIZE_out1(1)) fu_shell_sort_28861_29219 (.out1(out_lt_expr_FU_8_8_8_45_i0_fu_shell_sort_28861_29219), .in1(out_reg_31_reg_31), .in2(out_reg_36_reg_36));
  ...
  plus_expr_FU #(.BITSIZE_in1(15), .BITSIZE_in2(30), .BITSIZE_out1(31)) fu_shell_sort_28861_29277 (.out1(out_plus_expr_FU_32_32_32_51_i2_fu_shell_sort_28861_29277), .in1(out_reg_17_reg_17), .in2(out_reg_12_reg_12));
  ...
  plus_expr_FU #(.BITSIZE_in1(16), .BITSIZE_in2(20), .BITSIZE_out1(21)) fu_shell_sort_28861_29316 (.out1(out_plus_expr_FU_32_32_32_51_i4_fu_shell_sort_28861_29316), .in1(out_reg_5_reg_5), .in2(out_reg_6_reg_6));
  lshift_expr_FU #(.BITSIZE_in1(21), .BITSIZE_in2(4), .BITSIZE_out1(25), .PRECISION(32)) fu_shell_sort_28861_29321 (.out1(out_lshift_expr_FU_32_0_32_43_i2_fu_shell_sort_28861_29321), .in1(out_plus_expr_FU_32_32_32_51_i4_fu_shell_sort_28861_29316), .in2(out_const_2));
  ...
  plus_expr_FU #(.BITSIZE_in1(17), .BITSIZE_in2(24), .BITSIZE_out1(24)) fu_shell_sort_28861_29339 (.out1(out_plus_expr_FU_32_32_32_51_i5_fu_shell_sort_28861_29339), .in1(out_reg_13_reg_13), .in2(out_reg_14_reg_14));
  ...
  plus_expr_FU #(.BITSIZE_in1(16), .BITSIZE_in2(24), .BITSIZE_out1(24)) fu_shell_sort_28861_29390 (.out1(out_plus_expr_FU_32_32_32_51_i7_fu_shell_sort_28861_29390), .in1(out_reg_8_reg_8), .in2(out_reg_9_reg_9));
  ...
  register_STD #(.BITSIZE_in1(9), .BITSIZE_out1(9)) reg_10 (.out1(out_reg_10_reg_10), .clock(clock), .reset(reset), .in1(out_bit_and_expr_FU_16_0_16_30_i1_fu_shell_sort_28861_29396), .wenable(wrenable_reg_10));
  ...
  register_STD #(.BITSIZE_in1(17), .BITSIZE_out1(17)) reg_13 (.out1(out_reg_13_reg_13), .clock(clock), .reset(reset), .in1(out_rshift_expr_FU_32_0_32_59_i0_fu_shell_sort_28861_29332), .wenable(wrenable_reg_13));
  register_STD #(.BITSIZE_in1(24), .BITSIZE_out1(24)) reg_14 (.out1(out_reg_14_reg_14), .clock(clock), .reset(reset), .in1(out_rshift_expr_FU_32_0_32_59_i1_fu_shell_sort_28861_29335), .wenable(wrenable_reg_14));
  register_STD #(.BITSIZE_in1(9), .BITSIZE_out1(9)) reg_15 (.out1(out_reg_15_reg_15), .clock(clock), .reset(reset), .in1(out_bit_and_expr_FU_16_0_16_30_i0_fu_shell_sort_28861_29346), .wenable(wrenable_reg_15));
  register_SE #(.BITSIZE_in1(32), .BITSIZE_out1(32)) reg_16 (.out1(out_reg_16_reg_16), .clock(clock), .reset(reset), .in1(out_bit_ior_concat_expr_FU_38_i0_fu_shell_sort_28861_29189), .wenable(wrenable_reg_16));
  register_STD #(.BITSIZE_in1(15), .BITSIZE_out1(15)) reg_17 (.out1(out_reg_17_reg_17), .clock(clock), .reset(reset), .in1(out_rshift_expr_FU_16_0_16_52_i0_fu_shell_sort_28861_29270), .wenable(wrenable_reg_17));
  register_STD #(.BITSIZE_in1(2), .BITSIZE_out1(2)) reg_18 (.out1(out_reg_18_reg_18), .clock(clock), .reset(reset), .in1(out_bit_and_expr_FU_8_0_8_32_i1_fu_shell_sort_28861_29283), .wenable(wrenable_reg_18));
  register_STD #(.BITSIZE_in1(17), .BITSIZE_out1(17)) reg_19 (.out1(out_reg_19_reg_19), .clock(clock), .reset(reset), .in1(out_bit_and_expr_FU_32_0_32_31_i1_fu_shell_sort_28861_29141), .wenable(wrenable_reg_19));
  ...
  register_SE #(.BITSIZE_in1(16), .BITSIZE_out1(16)) reg_20 (.out1(out_reg_20_reg_20), .clock(clock), .reset(reset), .in1(out_rshift_expr_FU_32_0_32_54_i2_fu_shell_sort_28861_29144), .wenable(wrenable_reg_20));
  register_STD #(.BITSIZE_in1(16), .BITSIZE_out1(16)) reg_21 (.out1(out_reg_21_reg_21), .clock(clock), .reset(reset), .in1(out_rshift_expr_FU_32_0_32_54_i3_fu_shell_sort_28861_29154), .wenable(wrenable_reg_21));
  register_STD #(.BITSIZE_in1(32), .BITSIZE_out1(32)) reg_22 (.out1(out_reg_22_reg_22), .clock(clock), .reset(reset), .in1(out_ternary_plus_expr_FU_32_32_32_32_61_i0_fu_shell_sort_28861_29163), .wenable(wrenable_reg_22));
  register_SE #(.BITSIZE_in1(31), .BITSIZE_out1(31)) reg_23 (.out1(out_reg_23_reg_23), .clock(clock), .reset(reset), .in1(out_ternary_mp_expr_FU_32_32_0_32_60_i0_fu_shell_sort_28861_28977), .wenable(wrenable_reg_23));
  register_SE #(.BITSIZE_in1(8), .BITSIZE_out1(8)) reg_24 (.out1(out_reg_24_reg_24), .clock(clock), .reset(reset), .in1(out_IUdata_converter_FU_7_i0_fu_shell_sort_28861_29030), .wenable(wrenable_reg_24));
  register_STD #(.BITSIZE_in1(1), .BITSIZE_out1(1)) reg_25 (.out1(out_reg_25_reg_25), .clock(clock), .reset(reset), .in1(out_ui_gt_expr_FU_8_8_8_62_i0_fu_shell_sort_28861_29213), .wenable(wrenable_reg_25));
  register_SE #(.BITSIZE_in1(1), .BITSIZE_out1(1)) reg_26 (.out1(out_reg_26_reg_26), .clock(clock), .reset(reset), .in1(out_ne_expr_FU_32_0_32_48_i0_fu_shell_sort_28861_29215), .wenable(wrenable_reg_26));
  ...
  register_SE #(.BITSIZE_in1(8), .BITSIZE_out1(8)) reg_28 (.out1(out_reg_28_reg_28), .clock(clock), .reset(reset), .in1(out_ui_plus_expr_FU_8_0_8_65_i0_fu_shell_sort_28861_29023), .wenable(wrenable_reg_28));
  register_STD #(.BITSIZE_in1(7), .BITSIZE_out1(7)) reg_29 (.out1(out_reg_29_reg_29), .clock(clock), .reset(reset), .in1(out_ui_pointer_plus_expr_FU_8_8_8_66_i3_fu_shell_sort_28861_29065), .wenable(wrenable_reg_29));
  ...
  register_SE #(.BITSIZE_in1(1), .BITSIZE_out1(1)) reg_30 (.out1(out_reg_30_reg_30), .clock(clock), .reset(reset), .in1(out_ui_ne_expr_FU_8_8_8_64_i0_fu_shell_sort_28861_29221), .wenable(wrenable_reg_30));
  ...
  register_SE #(.BITSIZE_in1(7), .BITSIZE_out1(7)) reg_32 (.out1(out_reg_32_reg_32), .clock(clock), .reset(reset), .in1(out_ui_pointer_plus_expr_FU_8_8_8_66_i0_fu_shell_sort_28861_29001), .wenable(wrenable_reg_32));
  register_SE #(.BITSIZE_in1(8), .BITSIZE_out1(8)) reg_33 (.out1(out_reg_33_reg_33), .clock(clock), .reset(reset), .in1(out_ui_minus_expr_FU_8_8_8_63_i0_fu_shell_sort_28861_29026), .wenable(wrenable_reg_33));
  register_STD #(.BITSIZE_in1(7), .BITSIZE_out1(7)) reg_34 (.out1(out_reg_34_reg_34), .clock(clock), .reset(reset), .in1(out_ui_pointer_plus_expr_FU_8_8_8_66_i1_fu_shell_sort_28861_29037), .wenable(wrenable_reg_34));
  register_SE #(.BITSIZE_in1(1), .BITSIZE_out1(1)) reg_35 (.out1(out_reg_35_reg_35), .clock(clock), .reset(reset), .in1(out_gt_expr_FU_32_32_32_39_i0_fu_shell_sort_28861_29217), .wenable(wrenable_reg_35));
  ...
  register_STD #(.BITSIZE_in1(7), .BITSIZE_out1(7)) reg_38 (.out1(out_reg_38_reg_38), .clock(clock), .reset(reset), .in1(out_ui_pointer_plus_expr_FU_8_8_8_66_i2_fu_shell_sort_28861_29054), .wenable(wrenable_reg_38));
  ...
  register_STD #(.BITSIZE_in1(16), .BITSIZE_out1(16)) reg_5 (.out1(out_reg_5_reg_5), .clock(clock), .reset(reset), .in1(out_rshift_expr_FU_32_0_32_58_i0_fu_shell_sort_28861_29309), .wenable(wrenable_reg_5));
  register_STD #(.BITSIZE_in1(20), .BITSIZE_out1(20)) reg_6 (.out1(out_reg_6_reg_6), .clock(clock), .reset(reset), .in1(out_rshift_expr_FU_32_0_32_58_i1_fu_shell_sort_28861_29314), .wenable(wrenable_reg_6));
  register_STD #(.BITSIZE_in1(5), .BITSIZE_out1(5)) reg_7 (.out1(out_reg_7_reg_7), .clock(clock), .reset(reset), .in1(out_bit_and_expr_FU_8_0_8_34_i0_fu_shell_sort_28861_29327), .wenable(wrenable_reg_7));
  register_STD #(.BITSIZE_in1(16), .BITSIZE_out1(16)) reg_8 (.out1(out_reg_8_reg_8), .clock(clock), .reset(reset), .in1(out_rshift_expr_FU_32_0_32_59_i2_fu_shell_sort_28861_29385), .wenable(wrenable_reg_8));
  register_STD #(.BITSIZE_in1(24), .BITSIZE_out1(24)) reg_9 (.out1(out_reg_9_reg_9), .clock(clock), .reset(reset), .in1(out_rshift_expr_FU_32_0_32_59_i3_fu_shell_sort_28861_29388), .wenable(wrenable_reg_9));
