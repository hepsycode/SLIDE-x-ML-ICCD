...
// Code created using PandA - Version: PandA 0.9.6 - Revision 891ec3caed502474cab0813cc4a9fc678deabaa5 - Date 2022-05-27T22:06:46
// bambu executed with: bambu -I/home/dews/Scrivania/bambu-hls/RESULTS/BAMBU/28x28/bellmanford/includes/values_97 --simulate --simulator=VERILATOR --clock-period=5 --device-name=xc7a100t-1csg324-VVD /home/dews/Scrivania/bambu-hls/cc4cs_bambu/benchmarkBasic/bellmanford/thrd.c 
// 
...
module datapath_bellmanford(clock, reset, in_port_size, in_port_a, S_oe_ram, S_we_ram, S_addr_ram, S_Wdata_ram, S_data_ram_size, M_Rdata_ram, M_DataRdy, Sin_Rdata_ram, Sin_DataRdy, Sout_Rdata_ram, Sout_DataRdy, proxy_out1_28859, proxy_in1_28859, proxy_in2_28859, proxy_in3_28859, proxy_sel_LOAD_28859, proxy_sel_STORE_28859, proxy_out1_28861, proxy_in1_28861, proxy_in2_28861, proxy_in3_28861, proxy_sel_LOAD_28861, proxy_sel_STORE_28861, Min_oe_ram, Min_we_ram, Min_addr_ram, Min_Wdata_ram, Min_data_ram_size, Mout_oe_ram, Mout_we_ram, Mout_addr_ram, Mout_Wdata_ram, Mout_data_ram_size, fuselector_ARRAY_1D_STD_BRAM_NN_SDS_BUS_0_i0_LOAD, fuselector_ARRAY_1D_STD_BRAM_NN_SDS_BUS_0_i0_STORE, fuselector_ARRAY_1D_STD_BRAM_NN_SDS_BUS_0_i1_LOAD, fuselector_ARRAY_1D_STD_BRAM_NN_SDS_BUS_0_i1_STORE, fuselector_BMEMORY_CTRLN_47_i0_LOAD, fuselector_BMEMORY_CTRLN_47_i0_STORE, selector_MUX_19_PROXY_CTRLN_1_i0_0_0_0, selector_MUX_1_ARRAY_1D_STD_BRAM_NN_SDS_BUS_0_i0_1_0_0, selector_MUX_23_PROXY_CTRLN_2_i0_0_0_0, selector_MUX_4_ARRAY_1D_STD_BRAM_NN_SDS_BUS_0_i1_0_0_0, selector_MUX_5_ARRAY_1D_STD_BRAM_NN_SDS_BUS_0_i1_1_0_0, selector_MUX_5_ARRAY_1D_STD_BRAM_NN_SDS_BUS_0_i1_1_0_1, selector_MUX_64_reg_0_0_0_0, selector_MUX_66_reg_10_0_0_0, selector_MUX_68_reg_12_0_0_0, selector_MUX_70_reg_14_0_0_0, selector_MUX_70_reg_14_0_0_1, selector_MUX_72_reg_16_0_0_0, selector_MUX_72_reg_16_0_0_1, selector_MUX_78_reg_21_0_0_0, selector_MUX_78_reg_21_0_0_1, selector_MUX_88_reg_30_0_0_0, selector_MUX_90_reg_5_0_0_0, selector_MUX_90_reg_5_0_0_1, selector_MUX_92_reg_7_0_0_0, selector_MUX_92_reg_7_0_0_1, fuselector_PROXY_CTRLN_1_i0_LOAD, fuselector_PROXY_CTRLN_1_i0_STORE, fuselector_PROXY_CTRLN_2_i0_LOAD, fuselector_PROXY_CTRLN_2_i0_STORE, wrenable_reg_0, wrenable_reg_1, wrenable_reg_10, wrenable_reg_11, wrenable_reg_12, wrenable_reg_13, wrenable_reg_14, wrenable_reg_15, wrenable_reg_16, wrenable_reg_17, wrenable_reg_18, wrenable_reg_19, wrenable_reg_2, wrenable_reg_20, wrenable_reg_21, wrenable_reg_22, wrenable_reg_23, wrenable_reg_24, wrenable_reg_25, wrenable_reg_26, wrenable_reg_27, wrenable_reg_28, wrenable_reg_29, wrenable_reg_3, wrenable_reg_30, wrenable_reg_4, wrenable_reg_5, wrenable_reg_6, wrenable_reg_7, wrenable_reg_8, wrenable_reg_9, OUT_CONDITION_bellmanford_28866_28942, OUT_CONDITION_bellmanford_28866_28989, OUT_CONDITION_bellmanford_28866_29113, OUT_CONDITION_bellmanford_28866_29140, OUT_CONDITION_bellmanford_28866_29145);
  ...
  MUX_GATE #(.BITSIZE_in1(32), .BITSIZE_in2(32), .BITSIZE_out1(32)) MUX_66_reg_10_0_0_0 (.out1(out_MUX_66_reg_10_0_0_0), .sel(selector_MUX_66_reg_10_0_0_0), .in1(out_reg_15_reg_15), .in2(out_UUdata_converter_FU_9_i0_fu_bellmanford_28866_29011));
  ...
  MUX_GATE #(.BITSIZE_in1(3), .BITSIZE_in2(3), .BITSIZE_out1(3)) MUX_70_reg_14_0_0_1 (.out1(out_MUX_70_reg_14_0_0_1), .sel(selector_MUX_70_reg_14_0_0_1), .in1(out_ui_plus_expr_FU_8_0_8_63_i3_fu_bellmanford_28866_29098), .in2(out_MUX_70_reg_14_0_0_0));
  ...
  MUX_GATE #(.BITSIZE_in1(3), .BITSIZE_in2(3), .BITSIZE_out1(3)) MUX_78_reg_21_0_0_1 (.out1(out_MUX_78_reg_21_0_0_1), .sel(selector_MUX_78_reg_21_0_0_1), .in1(out_ui_plus_expr_FU_8_0_8_63_i2_fu_bellmanford_28866_29069), .in2(out_MUX_78_reg_21_0_0_0));
  MUX_GATE #(.BITSIZE_in1(8), .BITSIZE_in2(8), .BITSIZE_out1(8)) MUX_88_reg_30_0_0_0 (.out1(out_MUX_88_reg_30_0_0_0), .sel(selector_MUX_88_reg_30_0_0_0), .in1(out_reg_16_reg_16), .in2(out_plus_expr_FU_8_8_8_53_i0_fu_bellmanford_28866_29056));
  ...
  MUX_GATE #(.BITSIZE_in1(8), .BITSIZE_in2(8), .BITSIZE_out1(8)) MUX_90_reg_5_0_0_1 (.out1(out_MUX_90_reg_5_0_0_1), .sel(selector_MUX_90_reg_5_0_0_1), .in1(out_ui_lshift_expr_FU_8_0_8_60_i0_fu_bellmanford_28866_28940), .in2(out_MUX_90_reg_5_0_0_0));
  ...
  MUX_GATE #(.BITSIZE_in1(3), .BITSIZE_in2(3), .BITSIZE_out1(3)) MUX_92_reg_7_0_0_1 (.out1(out_MUX_92_reg_7_0_0_1), .sel(selector_MUX_92_reg_7_0_0_1), .in1(out_ui_plus_expr_FU_8_0_8_63_i1_fu_bellmanford_28866_28987), .in2(out_MUX_92_reg_7_0_0_0));
  ...
  ui_plus_expr_FU #(.BITSIZE_in1(2), .BITSIZE_in2(1), .BITSIZE_out1(3)) fu_bellmanford_28866_28987 (.out1(out_ui_plus_expr_FU_8_0_8_63_i1_fu_bellmanford_28866_28987), .in1(out_conv_out_reg_7_reg_7_3_2), .in2(out_const_4));
  ...
  read_cond_FU #(.BITSIZE_in1(1)) fu_bellmanford_28866_28989 (.out1(out_read_cond_FU_18_i0_fu_bellmanford_28866_28989), .in1(out_reg_9_reg_9));
  ...
  UUdata_converter_FU #(.BITSIZE_in1(32), .BITSIZE_out1(9)) fu_bellmanford_28866_29036 (.out1(out_UUdata_converter_FU_26_i0_fu_bellmanford_28866_29036), .in1(out_reg_10_reg_10));
  plus_expr_FU #(.BITSIZE_in1(8), .BITSIZE_in2(8), .BITSIZE_out1(8)) fu_bellmanford_28866_29056 (.out1(out_plus_expr_FU_8_8_8_53_i0_fu_bellmanford_28866_29056), .in1(out_reg_27_reg_27), .in2(out_reg_12_reg_12));
  ui_plus_expr_FU #(.BITSIZE_in1(2), .BITSIZE_in2(1), .BITSIZE_out1(3)) fu_bellmanford_28866_29069 (.out1(out_ui_plus_expr_FU_8_0_8_63_i2_fu_bellmanford_28866_29069), .in1(out_conv_out_reg_21_reg_21_3_2), .in2(out_const_4));
  ...
  UUdata_converter_FU #(.BITSIZE_in1(2), .BITSIZE_out1(2)) fu_bellmanford_28866_29081 (.out1(out_UUdata_converter_FU_39_i0_fu_bellmanford_28866_29081), .in1(out_conv_out_reg_21_reg_21_3_2));
  ...
  UUdata_converter_FU #(.BITSIZE_in1(2), .BITSIZE_out1(2)) fu_bellmanford_28866_29087 (.out1(out_UUdata_converter_FU_27_i0_fu_bellmanford_28866_29087), .in1(out_conv_out_reg_14_reg_14_3_2));
  ui_plus_expr_FU #(.BITSIZE_in1(2), .BITSIZE_in2(1), .BITSIZE_out1(3)) fu_bellmanford_28866_29098 (.out1(out_ui_plus_expr_FU_8_0_8_63_i3_fu_bellmanford_28866_29098), .in1(out_conv_out_reg_14_reg_14_3_2), .in2(out_const_4));
  ...
  IIdata_converter_FU #(.BITSIZE_in1(8), .BITSIZE_out1(8)) fu_bellmanford_28866_29106 (.out1(out_IIdata_converter_FU_36_i0_fu_bellmanford_28866_29106), .in1(out_reg_12_reg_12));
  ...
  plus_expr_FU #(.BITSIZE_in1(8), .BITSIZE_in2(8), .BITSIZE_out1(9)) fu_bellmanford_28866_29108 (.out1(out_plus_expr_FU_8_8_8_53_i1_fu_bellmanford_28866_29108), .in1(out_reg_28_reg_28), .in2(out_reg_22_reg_22));
  IIdata_converter_FU #(.BITSIZE_in1(8), .BITSIZE_out1(8)) fu_bellmanford_28866_29109 (.out1(out_IIdata_converter_FU_38_i0_fu_bellmanford_28866_29109), .in1(out_reg_16_reg_16));
  ne_expr_FU #(.BITSIZE_in1(8), .BITSIZE_in2(2), .BITSIZE_out1(1)) fu_bellmanford_28866_29110 (.out1(out_ne_expr_FU_8_0_8_51_i0_fu_bellmanford_28866_29110), .in1(out_reg_27_reg_27), .in2(out_const_6));
  lt_expr_FU #(.BITSIZE_in1(9), .BITSIZE_in2(8), .BITSIZE_out1(1)) fu_bellmanford_28866_29111 (.out1(out_lt_expr_FU_16_16_16_50_i0_fu_bellmanford_28866_29111), .in1(out_plus_expr_FU_8_8_8_53_i1_fu_bellmanford_28866_29108), .in2(out_reg_23_reg_23));
  ...
  read_cond_FU #(.BITSIZE_in1(1)) fu_bellmanford_28866_29113 (.out1(out_read_cond_FU_41_i0_fu_bellmanford_28866_29113), .in1(out_reg_29_reg_29));
  ...
  read_cond_FU #(.BITSIZE_in1(1)) fu_bellmanford_28866_29140 (.out1(out_read_cond_FU_44_i0_fu_bellmanford_28866_29140), .in1(out_reg_26_reg_26));
  ...
  read_cond_FU #(.BITSIZE_in1(1)) fu_bellmanford_28866_29145 (.out1(out_read_cond_FU_45_i0_fu_bellmanford_28866_29145), .in1(out_reg_19_reg_19));
  ...
  ui_pointer_plus_expr_FU #(.BITSIZE_in1(9), .BITSIZE_in2(2), .BITSIZE_out1(8), .LSB_PARAMETER(0)) fu_bellmanford_28866_29321 (.out1(out_ui_pointer_plus_expr_FU_8_8_8_65_i0_fu_bellmanford_28866_29321), .in1(out_reg_2_reg_2), .in2(out_conv_out_reg_7_reg_7_3_2));
  ...
  ui_pointer_plus_expr_FU #(.BITSIZE_in1(9), .BITSIZE_in2(2), .BITSIZE_out1(8), .LSB_PARAMETER(0)) fu_bellmanford_28866_29357 (.out1(out_ui_pointer_plus_expr_FU_8_8_8_65_i1_fu_bellmanford_28866_29357), .in1(out_reg_13_reg_13), .in2(out_conv_out_reg_21_reg_21_3_2));
  ui_pointer_plus_expr_FU #(.BITSIZE_in1(9), .BITSIZE_in2(2), .BITSIZE_out1(8), .LSB_PARAMETER(0)) fu_bellmanford_28866_29368 (.out1(out_ui_pointer_plus_expr_FU_8_8_8_65_i2_fu_bellmanford_28866_29368), .in1(out_reg_2_reg_2), .in2(out_conv_out_reg_14_reg_14_3_2));
  ...
  ui_rshift_expr_FU #(.BITSIZE_in1(32), .BITSIZE_in2(2), .BITSIZE_out1(30), .PRECISION(32)) fu_bellmanford_28866_29602 (.out1(out_ui_rshift_expr_FU_32_0_32_66_i0_fu_bellmanford_28866_29602), .in1(out_reg_10_reg_10), .in2(out_const_5));
  ...
  ui_bit_and_expr_FU #(.BITSIZE_in1(32), .BITSIZE_in2(2), .BITSIZE_out1(2)) fu_bellmanford_28866_29616 (.out1(out_ui_bit_and_expr_FU_8_0_8_56_i0_fu_bellmanford_28866_29616), .in1(out_reg_10_reg_10), .in2(out_const_6));
  ...
  register_SE #(.BITSIZE_in1(3), .BITSIZE_out1(3)) reg_11 (.out1(out_reg_11_reg_11), .clock(clock), .reset(reset), .in1(out_ui_plus_expr_FU_8_0_8_64_i1_fu_bellmanford_28866_29084), .wenable(wrenable_reg_11));
  ...
  register_SE #(.BITSIZE_in1(9), .BITSIZE_out1(9)) reg_13 (.out1(out_reg_13_reg_13), .clock(clock), .reset(reset), .in1(out_UUdata_converter_FU_26_i0_fu_bellmanford_28866_29036), .wenable(wrenable_reg_13));
  ...
  register_SE #(.BITSIZE_in1(32), .BITSIZE_out1(32)) reg_15 (.out1(out_reg_15_reg_15), .clock(clock), .reset(reset), .in1(out_ui_bit_ior_concat_expr_FU_57_i0_fu_bellmanford_28866_29102), .wenable(wrenable_reg_15));
  ...
  register_SE #(.BITSIZE_in1(8), .BITSIZE_out1(8)) reg_17 (.out1(out_reg_17_reg_17), .clock(clock), .reset(reset), .in1(out_ui_pointer_plus_expr_FU_8_8_8_65_i2_fu_bellmanford_28866_29368), .wenable(wrenable_reg_17));
  register_SE #(.BITSIZE_in1(8), .BITSIZE_out1(8)) reg_18 (.out1(out_reg_18_reg_18), .clock(clock), .reset(reset), .in1(out_ui_pointer_plus_expr_FU_8_8_8_65_i4_fu_bellmanford_28866_29415), .wenable(wrenable_reg_18));
  register_SE #(.BITSIZE_in1(1), .BITSIZE_out1(1)) reg_19 (.out1(out_reg_19_reg_19), .clock(clock), .reset(reset), .in1(out_ui_gt_expr_FU_8_8_8_58_i2_fu_bellmanford_28866_29567), .wenable(wrenable_reg_19));
  ...
  register_SE #(.BITSIZE_in1(3), .BITSIZE_out1(3)) reg_20 (.out1(out_reg_20_reg_20), .clock(clock), .reset(reset), .in1(out_ui_plus_expr_FU_8_0_8_64_i0_fu_bellmanford_28866_29078), .wenable(wrenable_reg_20));
  ...
  register_SE #(.BITSIZE_in1(8), .BITSIZE_out1(8)) reg_22 (.out1(out_reg_22_reg_22), .clock(clock), .reset(reset), .in1(out_IIdata_converter_FU_36_i0_fu_bellmanford_28866_29106), .wenable(wrenable_reg_22));
  register_SE #(.BITSIZE_in1(8), .BITSIZE_out1(8)) reg_23 (.out1(out_reg_23_reg_23), .clock(clock), .reset(reset), .in1(out_IIdata_converter_FU_38_i0_fu_bellmanford_28866_29109), .wenable(wrenable_reg_23));
  register_STD #(.BITSIZE_in1(8), .BITSIZE_out1(8)) reg_24 (.out1(out_reg_24_reg_24), .clock(clock), .reset(reset), .in1(out_ui_pointer_plus_expr_FU_8_8_8_65_i1_fu_bellmanford_28866_29357), .wenable(wrenable_reg_24));
  register_SE #(.BITSIZE_in1(8), .BITSIZE_out1(8)) reg_25 (.out1(out_reg_25_reg_25), .clock(clock), .reset(reset), .in1(out_ui_pointer_plus_expr_FU_8_8_8_65_i3_fu_bellmanford_28866_29383), .wenable(wrenable_reg_25));
  register_SE #(.BITSIZE_in1(1), .BITSIZE_out1(1)) reg_26 (.out1(out_reg_26_reg_26), .clock(clock), .reset(reset), .in1(out_ui_gt_expr_FU_8_8_8_58_i1_fu_bellmanford_28866_29565), .wenable(wrenable_reg_26));
  ...
  register_STD #(.BITSIZE_in1(8), .BITSIZE_out1(8)) reg_28 (.out1(out_reg_28_reg_28), .clock(clock), .reset(reset), .in1(out_IIdata_converter_FU_37_i0_fu_bellmanford_28866_29107), .wenable(wrenable_reg_28));
  register_STD #(.BITSIZE_in1(1), .BITSIZE_out1(1)) reg_29 (.out1(out_reg_29_reg_29), .clock(clock), .reset(reset), .in1(out_ui_bit_and_expr_FU_1_1_1_55_i0_fu_bellmanford_28866_29112), .wenable(wrenable_reg_29));
  ...
  register_STD #(.BITSIZE_in1(8), .BITSIZE_out1(8)) reg_8 (.out1(out_reg_8_reg_8), .clock(clock), .reset(reset), .in1(out_ui_pointer_plus_expr_FU_8_8_8_65_i0_fu_bellmanford_28866_29321), .wenable(wrenable_reg_8));
  register_STD #(.BITSIZE_in1(1), .BITSIZE_out1(1)) reg_9 (.out1(out_reg_9_reg_9), .clock(clock), .reset(reset), .in1(out_ui_gt_expr_FU_8_8_8_58_i0_fu_bellmanford_28866_29561), .wenable(wrenable_reg_9));
...
module datapath_make_oriented(clock, reset, proxy_out1_28859, proxy_in1_28859, proxy_in2_28859, proxy_in3_28859, proxy_sel_LOAD_28859, proxy_sel_STORE_28859, proxy_out1_28861, proxy_in1_28861, proxy_in2_28861, proxy_in3_28861, proxy_sel_LOAD_28861, proxy_sel_STORE_28861, proxy_out1_28864, proxy_in1_28864, proxy_in2_28864, proxy_in3_28864, proxy_sel_LOAD_28864, proxy_sel_STORE_28864, selector_MUX_12_PROXY_CTRLN_2_i0_0_0_0, selector_MUX_13_PROXY_CTRLN_2_i0_1_0_0, selector_MUX_13_PROXY_CTRLN_2_i0_1_0_1, selector_MUX_13_PROXY_CTRLN_2_i0_1_0_2, selector_MUX_13_PROXY_CTRLN_2_i0_1_1_0, selector_MUX_38_reg_11_0_0_0, selector_MUX_38_reg_11_0_0_1, selector_MUX_41_reg_14_0_0_0, selector_MUX_41_reg_14_0_0_1, selector_MUX_50_reg_3_0_0_0, selector_MUX_50_reg_3_0_0_1, selector_MUX_8_PROXY_CTRLN_1_i0_0_0_0, selector_MUX_9_PROXY_CTRLN_1_i0_1_0_0, fuselector_PROXY_CTRLN_0_i0_LOAD, fuselector_PROXY_CTRLN_0_i0_STORE, fuselector_PROXY_CTRLN_1_i0_LOAD, fuselector_PROXY_CTRLN_1_i0_STORE, fuselector_PROXY_CTRLN_2_i0_LOAD, fuselector_PROXY_CTRLN_2_i0_STORE, wrenable_reg_0, wrenable_reg_1, wrenable_reg_10, wrenable_reg_11, wrenable_reg_12, wrenable_reg_13, wrenable_reg_14, wrenable_reg_15, wrenable_reg_16, wrenable_reg_17, wrenable_reg_18, wrenable_reg_19, wrenable_reg_2, wrenable_reg_20, wrenable_reg_21, wrenable_reg_3, wrenable_reg_4, wrenable_reg_5, wrenable_reg_6, wrenable_reg_7, wrenable_reg_8, wrenable_reg_9, OUT_CONDITION_make_oriented_28867_29258, OUT_CONDITION_make_oriented_28867_29269, OUT_MULTIIF_make_oriented_28867_29694);
  ...
  MUX_GATE #(.BITSIZE_in1(8), .BITSIZE_in2(8), .BITSIZE_out1(8)) MUX_13_PROXY_CTRLN_2_i0_1_0_2 (.out1(out_MUX_13_PROXY_CTRLN_2_i0_1_0_2), .sel(selector_MUX_13_PROXY_CTRLN_2_i0_1_0_2), .in1(out_conv_out_UUdata_converter_FU_22_i0_fu_make_oriented_28867_29195_7_8), .in2(out_MUX_13_PROXY_CTRLN_2_i0_1_0_0));
  ...
  MUX_GATE #(.BITSIZE_in1(32), .BITSIZE_in2(32), .BITSIZE_out1(32)) MUX_38_reg_11_0_0_1 (.out1(out_MUX_38_reg_11_0_0_1), .sel(selector_MUX_38_reg_11_0_0_1), .in1(out_UUdata_converter_FU_7_i0_fu_make_oriented_28867_29160), .in2(out_MUX_38_reg_11_0_0_0));
  ...
  MUX_GATE #(.BITSIZE_in1(3), .BITSIZE_in2(3), .BITSIZE_out1(3)) MUX_41_reg_14_0_0_1 (.out1(out_MUX_41_reg_14_0_0_1), .sel(selector_MUX_41_reg_14_0_0_1), .in1(out_ui_plus_expr_FU_8_0_8_54_i0_fu_make_oriented_28867_29232), .in2(out_MUX_41_reg_14_0_0_0));
  ...
  MUX_GATE #(.BITSIZE_in1(3), .BITSIZE_in2(3), .BITSIZE_out1(3)) MUX_50_reg_3_0_0_1 (.out1(out_MUX_50_reg_3_0_0_1), .sel(selector_MUX_50_reg_3_0_0_1), .in1(out_ui_plus_expr_FU_8_0_8_54_i1_fu_make_oriented_28867_29238), .in2(out_MUX_50_reg_3_0_0_0));
  ...
  UUdata_converter_FU #(.BITSIZE_in1(32), .BITSIZE_out1(7)) fu_make_oriented_28867_29195 (.out1(out_UUdata_converter_FU_22_i0_fu_make_oriented_28867_29195), .in1(out_reg_11_reg_11));
  ui_plus_expr_FU #(.BITSIZE_in1(32), .BITSIZE_in2(1), .BITSIZE_out1(32)) fu_make_oriented_28867_29203 (.out1(out_ui_plus_expr_FU_32_0_32_52_i0_fu_make_oriented_28867_29203), .in1(out_reg_11_reg_11), .in2(out_const_4));
  ...
  ui_plus_expr_FU #(.BITSIZE_in1(2), .BITSIZE_in2(1), .BITSIZE_out1(3)) fu_make_oriented_28867_29232 (.out1(out_ui_plus_expr_FU_8_0_8_54_i0_fu_make_oriented_28867_29232), .in1(out_conv_out_reg_14_reg_14_3_2), .in2(out_const_4));
  ...
  UUdata_converter_FU #(.BITSIZE_in1(2), .BITSIZE_out1(2)) fu_make_oriented_28867_29254 (.out1(out_UUdata_converter_FU_23_i0_fu_make_oriented_28867_29254), .in1(out_conv_out_reg_14_reg_14_3_2));
  ...
  ui_bit_and_expr_FU #(.BITSIZE_in1(1), .BITSIZE_in2(1), .BITSIZE_out1(1)) fu_make_oriented_28867_29257 (.out1(out_ui_bit_and_expr_FU_1_1_1_38_i0_fu_make_oriented_28867_29257), .in1(out_lt_expr_FU_8_0_8_34_i0_fu_make_oriented_28867_29256), .in2(out_reg_15_reg_15));
  read_cond_FU #(.BITSIZE_in1(1)) fu_make_oriented_28867_29258 (.out1(out_read_cond_FU_26_i0_fu_make_oriented_28867_29258), .in1(out_reg_20_reg_20));
  read_cond_FU #(.BITSIZE_in1(1)) fu_make_oriented_28867_29269 (.out1(out_read_cond_FU_28_i0_fu_make_oriented_28867_29269), .in1(out_reg_21_reg_21));
  ...
  ui_pointer_plus_expr_FU #(.BITSIZE_in1(32), .BITSIZE_in2(8), .BITSIZE_out1(7), .LSB_PARAMETER(0)) fu_make_oriented_28867_29473 (.out1(out_ui_pointer_plus_expr_FU_8_8_8_56_i0_fu_make_oriented_28867_29473), .in1(out_reg_1_reg_1), .in2(out_reg_6_reg_6));
  ...
  ui_lshift_expr_FU #(.BITSIZE_in1(2), .BITSIZE_in2(2), .BITSIZE_out1(4), .PRECISION(32)) fu_make_oriented_28867_29527 (.out1(out_ui_lshift_expr_FU_8_0_8_47_i0_fu_make_oriented_28867_29527), .in1(out_conv_out_reg_14_reg_14_3_2), .in2(out_const_5));
  ...
  ui_rshift_expr_FU #(.BITSIZE_in1(32), .BITSIZE_in2(2), .BITSIZE_out1(30), .PRECISION(32)) fu_make_oriented_28867_29680 (.out1(out_ui_rshift_expr_FU_32_0_32_57_i0_fu_make_oriented_28867_29680), .in1(out_reg_11_reg_11), .in2(out_const_5));
  ...
  ui_bit_and_expr_FU #(.BITSIZE_in1(32), .BITSIZE_in2(2), .BITSIZE_out1(2)) fu_make_oriented_28867_29688 (.out1(out_ui_bit_and_expr_FU_8_0_8_39_i1_fu_make_oriented_28867_29688), .in1(out_reg_11_reg_11), .in2(out_const_7));
  multi_read_cond_FU #(.BITSIZE_in1(1), .PORTSIZE_in1(2), .BITSIZE_out1(2)) fu_make_oriented_28867_29694 (.out1(out_multi_read_cond_FU_31_i0_fu_make_oriented_28867_29694), .in1({out_reg_18_reg_18, out_reg_17_reg_17}));
  ...
  truth_and_expr_FU #(.BITSIZE_in1(1), .BITSIZE_in2(1), .BITSIZE_out1(1)) fu_make_oriented_28867_29700 (.out1(out_truth_and_expr_FU_1_1_1_35_i0_fu_make_oriented_28867_29700), .in1(out_reg_8_reg_8), .in2(out_truth_not_expr_FU_1_1_36_i0_fu_make_oriented_28867_29697));
  ...
  register_STD #(.BITSIZE_in1(7), .BITSIZE_out1(7)) reg_10 (.out1(out_reg_10_reg_10), .clock(clock), .reset(reset), .in1(out_ui_pointer_plus_expr_FU_8_8_8_56_i0_fu_make_oriented_28867_29473), .wenable(wrenable_reg_10));
  ...
  register_SE #(.BITSIZE_in1(7), .BITSIZE_out1(7)) reg_12 (.out1(out_reg_12_reg_12), .clock(clock), .reset(reset), .in1(out_UUdata_converter_FU_22_i0_fu_make_oriented_28867_29195), .wenable(wrenable_reg_12));
  register_SE #(.BITSIZE_in1(32), .BITSIZE_out1(32)) reg_13 (.out1(out_reg_13_reg_13), .clock(clock), .reset(reset), .in1(out_ui_plus_expr_FU_32_0_32_52_i0_fu_make_oriented_28867_29203), .wenable(wrenable_reg_13));
  ...
  register_STD #(.BITSIZE_in1(1), .BITSIZE_out1(1)) reg_15 (.out1(out_reg_15_reg_15), .clock(clock), .reset(reset), .in1(out_ui_ne_expr_FU_8_8_8_50_i0_fu_make_oriented_28867_29255), .wenable(wrenable_reg_15));
  register_SE #(.BITSIZE_in1(7), .BITSIZE_out1(7)) reg_16 (.out1(out_reg_16_reg_16), .clock(clock), .reset(reset), .in1(out_ui_pointer_plus_expr_FU_8_8_8_56_i2_fu_make_oriented_28867_29539), .wenable(wrenable_reg_16));
  register_SE #(.BITSIZE_in1(1), .BITSIZE_out1(1)) reg_17 (.out1(out_reg_17_reg_17), .clock(clock), .reset(reset), .in1(out_ui_ne_expr_FU_8_0_8_49_i0_fu_make_oriented_28867_29571), .wenable(wrenable_reg_17));
  register_SE #(.BITSIZE_in1(1), .BITSIZE_out1(1)) reg_18 (.out1(out_reg_18_reg_18), .clock(clock), .reset(reset), .in1(out_truth_and_expr_FU_1_1_1_35_i0_fu_make_oriented_28867_29700), .wenable(wrenable_reg_18));
  register_SE #(.BITSIZE_in1(8), .BITSIZE_out1(8)) reg_19 (.out1(out_reg_19_reg_19), .clock(clock), .reset(reset), .in1(out_UIdata_converter_FU_25_i0_fu_make_oriented_28867_29205), .wenable(wrenable_reg_19));
  ...
  register_STD #(.BITSIZE_in1(1), .BITSIZE_out1(1)) reg_20 (.out1(out_reg_20_reg_20), .clock(clock), .reset(reset), .in1(out_ui_bit_and_expr_FU_1_1_1_38_i0_fu_make_oriented_28867_29257), .wenable(wrenable_reg_20));
  register_STD #(.BITSIZE_in1(1), .BITSIZE_out1(1)) reg_21 (.out1(out_reg_21_reg_21), .clock(clock), .reset(reset), .in1(out_ge_expr_FU_8_0_8_33_i0_fu_make_oriented_28867_29524), .wenable(wrenable_reg_21));
  ...
  register_STD #(.BITSIZE_in1(8), .BITSIZE_out1(8)) reg_6 (.out1(out_reg_6_reg_6), .clock(clock), .reset(reset), .in1(out_ui_minus_expr_FU_8_8_8_48_i0_fu_make_oriented_28867_29456), .wenable(wrenable_reg_6));
  register_SE #(.BITSIZE_in1(7), .BITSIZE_out1(7)) reg_7 (.out1(out_reg_7_reg_7), .clock(clock), .reset(reset), .in1(out_ui_pointer_plus_expr_FU_8_8_8_56_i1_fu_make_oriented_28867_29486), .wenable(wrenable_reg_7));
  register_SE #(.BITSIZE_in1(1), .BITSIZE_out1(1)) reg_8 (.out1(out_reg_8_reg_8), .clock(clock), .reset(reset), .in1(out_ui_ne_expr_FU_8_0_8_49_i1_fu_make_oriented_28867_29573), .wenable(wrenable_reg_8));
  register_SE #(.BITSIZE_in1(2), .BITSIZE_out1(2)) reg_9 (.out1(out_reg_9_reg_9), .clock(clock), .reset(reset), .in1(out_ui_bit_and_expr_FU_8_0_8_40_i0_fu_make_oriented_28867_29676), .wenable(wrenable_reg_9));
