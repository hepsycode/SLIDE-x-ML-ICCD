...
// Code created using PandA - Version: PandA 0.9.6 - Revision 891ec3caed502474cab0813cc4a9fc678deabaa5 - Date 2022-06-14T20:11:11
// bambu executed with: bambu -I/home/dews/Scrivania/bambu-hls/RESULTS/Bambu/5SGXEA7N2F45C1-Stratix-V/28x28/bellmanford/includes/values_17 --simulate --simulator=VERILATOR --clock-period=5 --device-name=5SGXEA7N2F45C1 /home/dews/Scrivania/bambu-hls/cc4cs_bambu/benchmarkBasic/bellmanford/thrd.c 
// 
...
module datapath_bellmanford(clock, reset, in_port_size, in_port_a, S_oe_ram, S_we_ram, S_addr_ram, S_Wdata_ram, S_data_ram_size, M_Rdata_ram, M_DataRdy, Sin_Rdata_ram, Sin_DataRdy, Sout_Rdata_ram, Sout_DataRdy, proxy_out1_28859, proxy_in1_28859, proxy_in2_28859, proxy_in3_28859, proxy_sel_LOAD_28859, proxy_sel_STORE_28859, proxy_out1_28861, proxy_in1_28861, proxy_in2_28861, proxy_in3_28861, proxy_sel_LOAD_28861, proxy_sel_STORE_28861, Min_oe_ram, Min_we_ram, Min_addr_ram, Min_Wdata_ram, Min_data_ram_size, Mout_oe_ram, Mout_we_ram, Mout_addr_ram, Mout_Wdata_ram, Mout_data_ram_size, fuselector_ARRAY_1D_STD_BRAM_NN_SDS_BUS_0_i0_LOAD, fuselector_ARRAY_1D_STD_BRAM_NN_SDS_BUS_0_i0_STORE, fuselector_ARRAY_1D_STD_BRAM_NN_SDS_BUS_0_i1_LOAD, fuselector_ARRAY_1D_STD_BRAM_NN_SDS_BUS_0_i1_STORE, fuselector_BMEMORY_CTRLN_43_i0_LOAD, fuselector_BMEMORY_CTRLN_43_i0_STORE, selector_MUX_0_ARRAY_1D_STD_BRAM_NN_SDS_BUS_0_i0_0_0_0, selector_MUX_18_PROXY_CTRLN_1_i0_0_0_0, selector_MUX_1_ARRAY_1D_STD_BRAM_NN_SDS_BUS_0_i0_1_0_0, selector_MUX_22_PROXY_CTRLN_2_i0_0_0_0, selector_MUX_4_ARRAY_1D_STD_BRAM_NN_SDS_BUS_0_i1_0_0_0, selector_MUX_5_ARRAY_1D_STD_BRAM_NN_SDS_BUS_0_i1_1_0_0, selector_MUX_5_ARRAY_1D_STD_BRAM_NN_SDS_BUS_0_i1_1_0_1, selector_MUX_62_reg_0_0_0_0, selector_MUX_64_reg_10_0_0_0, selector_MUX_66_reg_12_0_0_0, selector_MUX_69_reg_15_0_0_0, selector_MUX_69_reg_15_0_0_1, selector_MUX_80_reg_25_0_0_0, selector_MUX_84_reg_6_0_0_0, selector_MUX_84_reg_6_0_0_1, selector_MUX_85_reg_7_0_0_0, selector_MUX_86_reg_8_0_0_0, fuselector_PROXY_CTRLN_1_i0_LOAD, fuselector_PROXY_CTRLN_1_i0_STORE, fuselector_PROXY_CTRLN_2_i0_LOAD, fuselector_PROXY_CTRLN_2_i0_STORE, wrenable_reg_0, wrenable_reg_1, wrenable_reg_10, wrenable_reg_11, wrenable_reg_12, wrenable_reg_13, wrenable_reg_14, wrenable_reg_15, wrenable_reg_16, wrenable_reg_17, wrenable_reg_18, wrenable_reg_19, wrenable_reg_2, wrenable_reg_20, wrenable_reg_21, wrenable_reg_22, wrenable_reg_23, wrenable_reg_24, wrenable_reg_25, wrenable_reg_3, wrenable_reg_4, wrenable_reg_5, wrenable_reg_6, wrenable_reg_7, wrenable_reg_8, wrenable_reg_9, OUT_CONDITION_bellmanford_28866_28926, OUT_CONDITION_bellmanford_28866_29091, OUT_CONDITION_bellmanford_28866_29118, OUT_CONDITION_bellmanford_28866_29123);
  ...
  input selector_MUX_64_reg_10_0_0_0;
  input selector_MUX_66_reg_12_0_0_0;
  input selector_MUX_69_reg_15_0_0_0;
  input selector_MUX_69_reg_15_0_0_1;
  input selector_MUX_80_reg_25_0_0_0;
  ...
  wire [7:0] out_MUX_64_reg_10_0_0_0;
  wire [1:0] out_MUX_66_reg_12_0_0_0;
  wire [7:0] out_MUX_69_reg_15_0_0_0;
  wire [7:0] out_MUX_69_reg_15_0_0_1;
  wire [7:0] out_MUX_80_reg_25_0_0_0;
  wire [7:0] out_MUX_84_reg_6_0_0_0;
  wire [7:0] out_MUX_84_reg_6_0_0_1;
  wire [1:0] out_MUX_85_reg_7_0_0_0;
  wire [31:0] out_MUX_86_reg_8_0_0_0;
  ...
  wire out_conv_out_MUX_66_reg_12_0_0_0_2_1;
  wire out_conv_out_MUX_85_reg_7_0_0_0_2_1;
  ...
  wire [7:0] out_conv_out_reg_9_reg_9_2_8;
  ...
  ASSIGN_UNSIGNED_FU #(.BITSIZE_in1(2), .BITSIZE_out1(2)) ASSIGN_UNSIGNED_FU_u_assign_8 (.out1(out_u_assign_conn_obj_8_ASSIGN_UNSIGNED_FU_u_assign_8), .in1(out_reg_13_reg_13));
  ASSIGN_UNSIGNED_FU #(.BITSIZE_in1(2), .BITSIZE_out1(2)) ASSIGN_UNSIGNED_FU_u_assign_9 (.out1(out_u_assign_conn_obj_9_ASSIGN_UNSIGNED_FU_u_assign_9), .in1(out_reg_20_reg_20));
  ASSIGN_VECTOR_BOOL_FU #(.BITSIZE_in1(8), .BITSIZE_out1(8)) ASSIGN_VECTOR_BOOL_FU_vb_assign_10 (.out1(out_vb_assign_conn_obj_11_ASSIGN_VECTOR_BOOL_FU_vb_assign_10), .in1(out_conv_out_reg_19_reg_19_2_8));
  ASSIGN_VECTOR_BOOL_FU #(.BITSIZE_in1(8), .BITSIZE_out1(8)) ASSIGN_VECTOR_BOOL_FU_vb_assign_11 (.out1(out_vb_assign_conn_obj_12_ASSIGN_VECTOR_BOOL_FU_vb_assign_11), .in1(out_conv_out_reg_9_reg_9_2_8));
  ...
  IUdata_converter_FU #(.BITSIZE_in1(8), .BITSIZE_out1(8)) IUdata_converter_FU_iu_conv_2 (.out1(out_iu_conv_conn_obj_4_IUdata_converter_FU_iu_conv_2), .in1(out_bit_ior_concat_expr_FU_44_i0_fu_bellmanford_28866_28950));
  IUdata_converter_FU #(.BITSIZE_in1(8), .BITSIZE_out1(8)) IUdata_converter_FU_iu_conv_3 (.out1(out_iu_conv_conn_obj_5_IUdata_converter_FU_iu_conv_3), .in1(out_bit_ior_concat_expr_FU_44_i0_fu_bellmanford_28866_28950));
  ...
  MUX_GATE #(.BITSIZE_in1(8), .BITSIZE_in2(8), .BITSIZE_out1(8)) MUX_1_ARRAY_1D_STD_BRAM_NN_SDS_BUS_0_i0_1_0_0 (.out1(out_MUX_1_ARRAY_1D_STD_BRAM_NN_SDS_BUS_0_i0_1_0_0), .sel(selector_MUX_1_ARRAY_1D_STD_BRAM_NN_SDS_BUS_0_i0_1_0_0), .in1(out_reg_23_reg_23), .in2(out_reg_2_reg_2));
  ...
  MUX_GATE #(.BITSIZE_in1(8), .BITSIZE_in2(8), .BITSIZE_out1(8)) MUX_5_ARRAY_1D_STD_BRAM_NN_SDS_BUS_0_i1_1_0_0 (.out1(out_MUX_5_ARRAY_1D_STD_BRAM_NN_SDS_BUS_0_i1_1_0_0), .sel(selector_MUX_5_ARRAY_1D_STD_BRAM_NN_SDS_BUS_0_i1_1_0_0), .in1(out_reg_3_reg_3), .in2(out_reg_17_reg_17));
  MUX_GATE #(.BITSIZE_in1(8), .BITSIZE_in2(8), .BITSIZE_out1(8)) MUX_5_ARRAY_1D_STD_BRAM_NN_SDS_BUS_0_i1_1_0_1 (.out1(out_MUX_5_ARRAY_1D_STD_BRAM_NN_SDS_BUS_0_i1_1_0_1), .sel(selector_MUX_5_ARRAY_1D_STD_BRAM_NN_SDS_BUS_0_i1_1_0_1), .in1(out_reg_16_reg_16), .in2(out_MUX_5_ARRAY_1D_STD_BRAM_NN_SDS_BUS_0_i1_1_0_0));
  ...
  MUX_GATE #(.BITSIZE_in1(8), .BITSIZE_in2(8), .BITSIZE_out1(8)) MUX_64_reg_10_0_0_0 (.out1(out_MUX_64_reg_10_0_0_0), .sel(selector_MUX_64_reg_10_0_0_0), .in1(out_ARRAY_1D_STD_BRAM_NN_SDS_BUS_0_i0_array_28862_0), .in2(out_conv_out_i_assign_conn_obj_7_ASSIGN_SIGNED_FU_i_assign_0_I_1_8));
  MUX_GATE #(.BITSIZE_in1(2), .BITSIZE_in2(2), .BITSIZE_out1(2)) MUX_66_reg_12_0_0_0 (.out1(out_MUX_66_reg_12_0_0_0), .sel(selector_MUX_66_reg_12_0_0_0), .in1(out_conv_out_const_0_1_2), .in2(out_u_assign_conn_obj_9_ASSIGN_UNSIGNED_FU_u_assign_9));
  MUX_GATE #(.BITSIZE_in1(8), .BITSIZE_in2(8), .BITSIZE_out1(8)) MUX_69_reg_15_0_0_0 (.out1(out_MUX_69_reg_15_0_0_0), .sel(selector_MUX_69_reg_15_0_0_0), .in1(out_reg_25_reg_25), .in2(out_ARRAY_1D_STD_BRAM_NN_SDS_BUS_0_i1_array_28862_0));
  MUX_GATE #(.BITSIZE_in1(8), .BITSIZE_in2(8), .BITSIZE_out1(8)) MUX_69_reg_15_0_0_1 (.out1(out_MUX_69_reg_15_0_0_1), .sel(selector_MUX_69_reg_15_0_0_1), .in1(out_conv_out_i_assign_conn_obj_7_ASSIGN_SIGNED_FU_i_assign_0_I_1_8), .in2(out_MUX_69_reg_15_0_0_0));
  MUX_GATE #(.BITSIZE_in1(8), .BITSIZE_in2(8), .BITSIZE_out1(8)) MUX_80_reg_25_0_0_0 (.out1(out_MUX_80_reg_25_0_0_0), .sel(selector_MUX_80_reg_25_0_0_0), .in1(out_reg_15_reg_15), .in2(out_plus_expr_FU_8_8_8_49_i0_fu_bellmanford_28866_29018));
  MUX_GATE #(.BITSIZE_in1(8), .BITSIZE_in2(8), .BITSIZE_out1(8)) MUX_84_reg_6_0_0_0 (.out1(out_MUX_84_reg_6_0_0_0), .sel(selector_MUX_84_reg_6_0_0_0), .in1(out_conv_out_u_assign_conn_obj_0_ASSIGN_UNSIGNED_FU_u_assign_5_1_8), .in2(out_u_assign_conn_obj_1_ASSIGN_UNSIGNED_FU_u_assign_6));
  MUX_GATE #(.BITSIZE_in1(8), .BITSIZE_in2(8), .BITSIZE_out1(8)) MUX_84_reg_6_0_0_1 (.out1(out_MUX_84_reg_6_0_0_1), .sel(selector_MUX_84_reg_6_0_0_1), .in1(out_ui_lshift_expr_FU_8_0_8_56_i0_fu_bellmanford_28866_28924), .in2(out_MUX_84_reg_6_0_0_0));
  MUX_GATE #(.BITSIZE_in1(2), .BITSIZE_in2(2), .BITSIZE_out1(2)) MUX_85_reg_7_0_0_0 (.out1(out_MUX_85_reg_7_0_0_0), .sel(selector_MUX_85_reg_7_0_0_0), .in1(out_conv_out_const_0_1_2), .in2(out_u_assign_conn_obj_8_ASSIGN_UNSIGNED_FU_u_assign_8));
  MUX_GATE #(.BITSIZE_in1(32), .BITSIZE_in2(32), .BITSIZE_out1(32)) MUX_86_reg_8_0_0_0 (.out1(out_MUX_86_reg_8_0_0_0), .sel(selector_MUX_86_reg_8_0_0_0), .in1(out_reg_14_reg_14), .in2(out_UUdata_converter_FU_8_i0_fu_bellmanford_28866_29068));
  ...
  UUdata_converter_FU #(.BITSIZE_in1(2), .BITSIZE_out1(1)) conv_out_MUX_66_reg_12_0_0_0_2_1 (.out1(out_conv_out_MUX_66_reg_12_0_0_0_2_1), .in1(out_MUX_66_reg_12_0_0_0));
  UUdata_converter_FU #(.BITSIZE_in1(2), .BITSIZE_out1(1)) conv_out_MUX_85_reg_7_0_0_0_2_1 (.out1(out_conv_out_MUX_85_reg_7_0_0_0_2_1), .in1(out_MUX_85_reg_7_0_0_0));
  ...
  UUdata_converter_FU #(.BITSIZE_in1(2), .BITSIZE_out1(8)) conv_out_reg_9_reg_9_2_8 (.out1(out_conv_out_reg_9_reg_9_2_8), .in1(out_reg_9_reg_9));
  ...
  UUdata_converter_FU #(.BITSIZE_in1(32), .BITSIZE_out1(9)) fu_bellmanford_28866_28989 (.out1(out_UUdata_converter_FU_22_i0_fu_bellmanford_28866_28989), .in1(out_reg_8_reg_8));
  plus_expr_FU #(.BITSIZE_in1(8), .BITSIZE_in2(8), .BITSIZE_out1(8)) fu_bellmanford_28866_29018 (.out1(out_plus_expr_FU_8_8_8_49_i0_fu_bellmanford_28866_29018), .in1(out_BMEMORY_CTRLN_43_i0_BMEMORY_CTRLN_43_i0), .in2(out_reg_10_reg_10));
  ui_plus_expr_FU #(.BITSIZE_in1(1), .BITSIZE_in2(1), .BITSIZE_out1(2)) fu_bellmanford_28866_29031 (.out1(out_ui_plus_expr_FU_1_0_1_58_i0_fu_bellmanford_28866_29031), .in1(out_reg_12_reg_12), .in2(out_const_4));
  ...
  UUdata_converter_FU #(.BITSIZE_in1(1), .BITSIZE_out1(1)) fu_bellmanford_28866_29045 (.out1(out_UUdata_converter_FU_35_i0_fu_bellmanford_28866_29045), .in1(out_reg_12_reg_12));
  ...
  UUdata_converter_FU #(.BITSIZE_in1(1), .BITSIZE_out1(1)) fu_bellmanford_28866_29050 (.out1(out_UUdata_converter_FU_23_i0_fu_bellmanford_28866_29050), .in1(out_reg_7_reg_7));
  ui_plus_expr_FU #(.BITSIZE_in1(1), .BITSIZE_in2(1), .BITSIZE_out1(2)) fu_bellmanford_28866_29061 (.out1(out_ui_plus_expr_FU_1_0_1_58_i1_fu_bellmanford_28866_29061), .in1(out_reg_7_reg_7), .in2(out_const_4));
  ...
  IIdata_converter_FU #(.BITSIZE_in1(8), .BITSIZE_out1(8)) fu_bellmanford_28866_29084 (.out1(out_IIdata_converter_FU_32_i0_fu_bellmanford_28866_29084), .in1(out_reg_10_reg_10));
  ...
  plus_expr_FU #(.BITSIZE_in1(8), .BITSIZE_in2(8), .BITSIZE_out1(9)) fu_bellmanford_28866_29086 (.out1(out_plus_expr_FU_8_8_8_49_i1_fu_bellmanford_28866_29086), .in1(out_IIdata_converter_FU_33_i0_fu_bellmanford_28866_29085), .in2(out_reg_21_reg_21));
  IIdata_converter_FU #(.BITSIZE_in1(8), .BITSIZE_out1(8)) fu_bellmanford_28866_29087 (.out1(out_IIdata_converter_FU_34_i0_fu_bellmanford_28866_29087), .in1(out_reg_15_reg_15));
  ne_expr_FU #(.BITSIZE_in1(8), .BITSIZE_in2(2), .BITSIZE_out1(1)) fu_bellmanford_28866_29088 (.out1(out_ne_expr_FU_8_0_8_47_i0_fu_bellmanford_28866_29088), .in1(out_BMEMORY_CTRLN_43_i0_BMEMORY_CTRLN_43_i0), .in2(out_const_5));
  lt_expr_FU #(.BITSIZE_in1(9), .BITSIZE_in2(8), .BITSIZE_out1(1)) fu_bellmanford_28866_29089 (.out1(out_lt_expr_FU_16_16_16_46_i0_fu_bellmanford_28866_29089), .in1(out_plus_expr_FU_8_8_8_49_i1_fu_bellmanford_28866_29086), .in2(out_reg_22_reg_22));
  ...
  read_cond_FU #(.BITSIZE_in1(1)) fu_bellmanford_28866_29091 (.out1(out_read_cond_FU_37_i0_fu_bellmanford_28866_29091), .in1(out_ui_bit_and_expr_FU_1_1_1_52_i0_fu_bellmanford_28866_29090));
  ...
  read_cond_FU #(.BITSIZE_in1(1)) fu_bellmanford_28866_29118 (.out1(out_read_cond_FU_40_i0_fu_bellmanford_28866_29118), .in1(out_reg_24_reg_24));
  ...
  read_cond_FU #(.BITSIZE_in1(1)) fu_bellmanford_28866_29123 (.out1(out_read_cond_FU_41_i0_fu_bellmanford_28866_29123), .in1(out_reg_18_reg_18));
  ...
  ui_pointer_plus_expr_FU #(.BITSIZE_in1(9), .BITSIZE_in2(1), .BITSIZE_out1(8), .LSB_PARAMETER(0)) fu_bellmanford_28866_29330 (.out1(out_ui_pointer_plus_expr_FU_8_8_8_63_i0_fu_bellmanford_28866_29330), .in1(out_reg_11_reg_11), .in2(out_reg_12_reg_12));
  ...
  ui_pointer_plus_expr_FU #(.BITSIZE_in1(9), .BITSIZE_in2(1), .BITSIZE_out1(8), .LSB_PARAMETER(0)) fu_bellmanford_28866_29341 (.out1(out_ui_pointer_plus_expr_FU_8_8_8_63_i1_fu_bellmanford_28866_29341), .in1(out_reg_5_reg_5), .in2(out_reg_7_reg_7));
  ...
  ui_rshift_expr_FU #(.BITSIZE_in1(32), .BITSIZE_in2(1), .BITSIZE_out1(31), .PRECISION(32)) fu_bellmanford_28866_29581 (.out1(out_ui_rshift_expr_FU_32_0_32_64_i0_fu_bellmanford_28866_29581), .in1(out_reg_8_reg_8), .in2(out_const_4));
  ...
  ui_bit_and_expr_FU #(.BITSIZE_in1(32), .BITSIZE_in2(1), .BITSIZE_out1(1)) fu_bellmanford_28866_29597 (.out1(out_ui_bit_and_expr_FU_1_0_1_51_i0_fu_bellmanford_28866_29597), .in1(out_reg_8_reg_8), .in2(out_const_4));
  ...
  register_SE #(.BITSIZE_in1(8), .BITSIZE_out1(8)) reg_10 (.out1(out_reg_10_reg_10), .clock(clock), .reset(reset), .in1(out_MUX_64_reg_10_0_0_0), .wenable(wrenable_reg_10));
  register_SE #(.BITSIZE_in1(9), .BITSIZE_out1(9)) reg_11 (.out1(out_reg_11_reg_11), .clock(clock), .reset(reset), .in1(out_UUdata_converter_FU_22_i0_fu_bellmanford_28866_28989), .wenable(wrenable_reg_11));
  register_SE #(.BITSIZE_in1(1), .BITSIZE_out1(1)) reg_12 (.out1(out_reg_12_reg_12), .clock(clock), .reset(reset), .in1(out_conv_out_MUX_66_reg_12_0_0_0_2_1), .wenable(wrenable_reg_12));
  register_SE #(.BITSIZE_in1(2), .BITSIZE_out1(2)) reg_13 (.out1(out_reg_13_reg_13), .clock(clock), .reset(reset), .in1(out_ui_plus_expr_FU_1_0_1_58_i1_fu_bellmanford_28866_29061), .wenable(wrenable_reg_13));
  register_SE #(.BITSIZE_in1(32), .BITSIZE_out1(32)) reg_14 (.out1(out_reg_14_reg_14), .clock(clock), .reset(reset), .in1(out_ui_bit_ior_concat_expr_FU_53_i0_fu_bellmanford_28866_29072), .wenable(wrenable_reg_14));
  register_SE #(.BITSIZE_in1(8), .BITSIZE_out1(8)) reg_15 (.out1(out_reg_15_reg_15), .clock(clock), .reset(reset), .in1(out_MUX_69_reg_15_0_0_1), .wenable(wrenable_reg_15));
  register_SE #(.BITSIZE_in1(8), .BITSIZE_out1(8)) reg_16 (.out1(out_reg_16_reg_16), .clock(clock), .reset(reset), .in1(out_ui_pointer_plus_expr_FU_8_8_8_63_i1_fu_bellmanford_28866_29341), .wenable(wrenable_reg_16));
  register_SE #(.BITSIZE_in1(8), .BITSIZE_out1(8)) reg_17 (.out1(out_reg_17_reg_17), .clock(clock), .reset(reset), .in1(out_ui_pointer_plus_expr_FU_8_8_8_63_i3_fu_bellmanford_28866_29388), .wenable(wrenable_reg_17));
  register_SE #(.BITSIZE_in1(1), .BITSIZE_out1(1)) reg_18 (.out1(out_reg_18_reg_18), .clock(clock), .reset(reset), .in1(out_ui_gt_expr_FU_8_8_8_54_i1_fu_bellmanford_28866_29547), .wenable(wrenable_reg_18));
  register_SE #(.BITSIZE_in1(2), .BITSIZE_out1(2)) reg_19 (.out1(out_reg_19_reg_19), .clock(clock), .reset(reset), .in1(out_ui_plus_expr_FU_1_0_1_59_i0_fu_bellmanford_28866_29041), .wenable(wrenable_reg_19));
  ...
  register_SE #(.BITSIZE_in1(2), .BITSIZE_out1(2)) reg_20 (.out1(out_reg_20_reg_20), .clock(clock), .reset(reset), .in1(out_ui_plus_expr_FU_1_0_1_58_i0_fu_bellmanford_28866_29031), .wenable(wrenable_reg_20));
  register_STD #(.BITSIZE_in1(8), .BITSIZE_out1(8)) reg_21 (.out1(out_reg_21_reg_21), .clock(clock), .reset(reset), .in1(out_IIdata_converter_FU_32_i0_fu_bellmanford_28866_29084), .wenable(wrenable_reg_21));
  register_STD #(.BITSIZE_in1(8), .BITSIZE_out1(8)) reg_22 (.out1(out_reg_22_reg_22), .clock(clock), .reset(reset), .in1(out_IIdata_converter_FU_34_i0_fu_bellmanford_28866_29087), .wenable(wrenable_reg_22));
  register_SE #(.BITSIZE_in1(8), .BITSIZE_out1(8)) reg_23 (.out1(out_reg_23_reg_23), .clock(clock), .reset(reset), .in1(out_ui_pointer_plus_expr_FU_8_8_8_63_i2_fu_bellmanford_28866_29356), .wenable(wrenable_reg_23));
  register_SE #(.BITSIZE_in1(1), .BITSIZE_out1(1)) reg_24 (.out1(out_reg_24_reg_24), .clock(clock), .reset(reset), .in1(out_ui_gt_expr_FU_8_8_8_54_i0_fu_bellmanford_28866_29545), .wenable(wrenable_reg_24));
  register_SE #(.BITSIZE_in1(8), .BITSIZE_out1(8)) reg_25 (.out1(out_reg_25_reg_25), .clock(clock), .reset(reset), .in1(out_MUX_80_reg_25_0_0_0), .wenable(wrenable_reg_25));
  ...
  register_SE #(.BITSIZE_in1(1), .BITSIZE_out1(1)) reg_7 (.out1(out_reg_7_reg_7), .clock(clock), .reset(reset), .in1(out_conv_out_MUX_85_reg_7_0_0_0_2_1), .wenable(wrenable_reg_7));
  register_SE #(.BITSIZE_in1(32), .BITSIZE_out1(32)) reg_8 (.out1(out_reg_8_reg_8), .clock(clock), .reset(reset), .in1(out_MUX_86_reg_8_0_0_0), .wenable(wrenable_reg_8));
  register_SE #(.BITSIZE_in1(2), .BITSIZE_out1(2)) reg_9 (.out1(out_reg_9_reg_9), .clock(clock), .reset(reset), .in1(out_ui_plus_expr_FU_1_0_1_59_i1_fu_bellmanford_28866_29047), .wenable(wrenable_reg_9));
...
module controller_bellmanford(done_port, fuselector_ARRAY_1D_STD_BRAM_NN_SDS_BUS_0_i0_LOAD, fuselector_ARRAY_1D_STD_BRAM_NN_SDS_BUS_0_i0_STORE, fuselector_ARRAY_1D_STD_BRAM_NN_SDS_BUS_0_i1_LOAD, fuselector_ARRAY_1D_STD_BRAM_NN_SDS_BUS_0_i1_STORE, fuselector_BMEMORY_CTRLN_43_i0_LOAD, fuselector_BMEMORY_CTRLN_43_i0_STORE, selector_MUX_0_ARRAY_1D_STD_BRAM_NN_SDS_BUS_0_i0_0_0_0, selector_MUX_18_PROXY_CTRLN_1_i0_0_0_0, selector_MUX_1_ARRAY_1D_STD_BRAM_NN_SDS_BUS_0_i0_1_0_0, selector_MUX_22_PROXY_CTRLN_2_i0_0_0_0, selector_MUX_4_ARRAY_1D_STD_BRAM_NN_SDS_BUS_0_i1_0_0_0, selector_MUX_5_ARRAY_1D_STD_BRAM_NN_SDS_BUS_0_i1_1_0_0, selector_MUX_5_ARRAY_1D_STD_BRAM_NN_SDS_BUS_0_i1_1_0_1, selector_MUX_62_reg_0_0_0_0, selector_MUX_64_reg_10_0_0_0, selector_MUX_66_reg_12_0_0_0, selector_MUX_69_reg_15_0_0_0, selector_MUX_69_reg_15_0_0_1, selector_MUX_80_reg_25_0_0_0, selector_MUX_84_reg_6_0_0_0, selector_MUX_84_reg_6_0_0_1, selector_MUX_85_reg_7_0_0_0, selector_MUX_86_reg_8_0_0_0, fuselector_PROXY_CTRLN_1_i0_LOAD, fuselector_PROXY_CTRLN_1_i0_STORE, fuselector_PROXY_CTRLN_2_i0_LOAD, fuselector_PROXY_CTRLN_2_i0_STORE, wrenable_reg_0, wrenable_reg_1, wrenable_reg_10, wrenable_reg_11, wrenable_reg_12, wrenable_reg_13, wrenable_reg_14, wrenable_reg_15, wrenable_reg_16, wrenable_reg_17, wrenable_reg_18, wrenable_reg_19, wrenable_reg_2, wrenable_reg_20, wrenable_reg_21, wrenable_reg_22, wrenable_reg_23, wrenable_reg_24, wrenable_reg_25, wrenable_reg_3, wrenable_reg_4, wrenable_reg_5, wrenable_reg_6, wrenable_reg_7, wrenable_reg_8, wrenable_reg_9, OUT_CONDITION_bellmanford_28866_28926, OUT_CONDITION_bellmanford_28866_29091, OUT_CONDITION_bellmanford_28866_29118, OUT_CONDITION_bellmanford_28866_29123, clock, reset, start_port);
  ...
  output selector_MUX_64_reg_10_0_0_0;
  output selector_MUX_66_reg_12_0_0_0;
  output selector_MUX_69_reg_15_0_0_0;
  output selector_MUX_69_reg_15_0_0_1;
  output selector_MUX_80_reg_25_0_0_0;
  ...
  reg selector_MUX_64_reg_10_0_0_0;
  reg selector_MUX_66_reg_12_0_0_0;
  reg selector_MUX_69_reg_15_0_0_0;
  reg selector_MUX_69_reg_15_0_0_1;
  reg selector_MUX_80_reg_25_0_0_0;
  ...
  begin
    ...
    selector_MUX_64_reg_10_0_0_0 = 1'b0;
    selector_MUX_66_reg_12_0_0_0 = 1'b0;
    selector_MUX_69_reg_15_0_0_0 = 1'b0;
    selector_MUX_69_reg_15_0_0_1 = 1'b0;
    selector_MUX_80_reg_25_0_0_0 = 1'b0;
    ...
    case (_present_state)
      S_0 :
        ...
        begin
          ...
          selector_MUX_64_reg_10_0_0_0 = 1'bX;
          selector_MUX_66_reg_12_0_0_0 = 1'bX;
          selector_MUX_69_reg_15_0_0_0 = 1'bX;
          selector_MUX_69_reg_15_0_0_1 = 1'bX;
          selector_MUX_80_reg_25_0_0_0 = 1'bX;
      ...
      S_4 :
        begin
          selector_MUX_66_reg_12_0_0_0 = 1'b1;
      ...
      S_6 :
        begin
          selector_MUX_80_reg_25_0_0_0 = 1'b1;
      ...
      S_13 :
        begin
          selector_MUX_64_reg_10_0_0_0 = 1'b1;
...
module bellmanford(clock, reset, start_port, done_port, size, a, S_oe_ram, S_we_ram, S_addr_ram, S_Wdata_ram, S_data_ram_size, M_Rdata_ram, M_DataRdy, Sin_Rdata_ram, Sin_DataRdy, proxy_out1_28859, proxy_out1_28861, Min_oe_ram, Min_we_ram, Min_addr_ram, Min_Wdata_ram, Min_data_ram_size, Sout_Rdata_ram, Sout_DataRdy, proxy_in1_28859, proxy_in2_28859, proxy_in3_28859, proxy_sel_LOAD_28859, proxy_sel_STORE_28859, proxy_in1_28861, proxy_in2_28861, proxy_in3_28861, proxy_sel_LOAD_28861, proxy_sel_STORE_28861, Mout_oe_ram, Mout_we_ram, Mout_addr_ram, Mout_Wdata_ram, Mout_data_ram_size);
  ...
  wire selector_MUX_64_reg_10_0_0_0;
  wire selector_MUX_66_reg_12_0_0_0;
  wire selector_MUX_69_reg_15_0_0_0;
  wire selector_MUX_69_reg_15_0_0_1;
  wire selector_MUX_80_reg_25_0_0_0;
...
module datapath_make_oriented(clock, reset, proxy_out1_28859, proxy_in1_28859, proxy_in2_28859, proxy_in3_28859, proxy_sel_LOAD_28859, proxy_sel_STORE_28859, proxy_out1_28861, proxy_in1_28861, proxy_in2_28861, proxy_in3_28861, proxy_sel_LOAD_28861, proxy_sel_STORE_28861, proxy_out1_28864, proxy_in1_28864, proxy_in2_28864, proxy_in3_28864, proxy_sel_LOAD_28864, proxy_sel_STORE_28864, selector_MUX_12_PROXY_CTRLN_2_i0_0_0_0, selector_MUX_13_PROXY_CTRLN_2_i0_1_0_0, selector_MUX_13_PROXY_CTRLN_2_i0_1_0_1, selector_MUX_13_PROXY_CTRLN_2_i0_1_0_2, selector_MUX_13_PROXY_CTRLN_2_i0_1_1_0, selector_MUX_13_PROXY_CTRLN_2_i0_1_1_1, selector_MUX_36_reg_10_0_0_0, selector_MUX_52_reg_9_0_0_0, selector_MUX_52_reg_9_0_0_1, selector_MUX_8_PROXY_CTRLN_1_i0_0_0_0, selector_MUX_9_PROXY_CTRLN_1_i0_1_0_0, fuselector_PROXY_CTRLN_0_i0_LOAD, fuselector_PROXY_CTRLN_0_i0_STORE, fuselector_PROXY_CTRLN_1_i0_LOAD, fuselector_PROXY_CTRLN_1_i0_STORE, fuselector_PROXY_CTRLN_2_i0_LOAD, fuselector_PROXY_CTRLN_2_i0_STORE, wrenable_reg_0, wrenable_reg_1, wrenable_reg_10, wrenable_reg_11, wrenable_reg_12, wrenable_reg_13, wrenable_reg_14, wrenable_reg_15, wrenable_reg_16, wrenable_reg_17, wrenable_reg_18, wrenable_reg_2, wrenable_reg_3, wrenable_reg_4, wrenable_reg_5, wrenable_reg_6, wrenable_reg_7, wrenable_reg_8, wrenable_reg_9, OUT_CONDITION_make_oriented_28867_29227, OUT_CONDITION_make_oriented_28867_29240, OUT_MULTIIF_make_oriented_28867_29700);
  ...
  wire [7:0] out_conv_out_reg_13_reg_13_7_8;
  wire [7:0] out_conv_out_reg_14_reg_14_7_8;
  wire [7:0] out_conv_out_reg_2_reg_2_6_8;
  wire [7:0] out_conv_out_reg_4_reg_4_7_8;
  wire [7:0] out_conv_out_ui_pointer_plus_expr_FU_8_8_8_52_i0_fu_make_oriented_28867_29453_7_8;
  ...
  MUX_GATE #(.BITSIZE_in1(8), .BITSIZE_in2(8), .BITSIZE_out1(8)) MUX_13_PROXY_CTRLN_2_i0_1_0_0 (.out1(out_MUX_13_PROXY_CTRLN_2_i0_1_0_0), .sel(selector_MUX_13_PROXY_CTRLN_2_i0_1_0_0), .in1(out_conv_out_reg_4_reg_4_7_8), .in2(out_conv_out_reg_14_reg_14_7_8));
  MUX_GATE #(.BITSIZE_in1(8), .BITSIZE_in2(8), .BITSIZE_out1(8)) MUX_13_PROXY_CTRLN_2_i0_1_0_1 (.out1(out_MUX_13_PROXY_CTRLN_2_i0_1_0_1), .sel(selector_MUX_13_PROXY_CTRLN_2_i0_1_0_1), .in1(out_conv_out_reg_13_reg_13_7_8), .in2(out_conv_out_reg_11_reg_11_7_8));
  MUX_GATE #(.BITSIZE_in1(8), .BITSIZE_in2(8), .BITSIZE_out1(8)) MUX_13_PROXY_CTRLN_2_i0_1_0_2 (.out1(out_MUX_13_PROXY_CTRLN_2_i0_1_0_2), .sel(selector_MUX_13_PROXY_CTRLN_2_i0_1_0_2), .in1(out_conv_out_UUdata_converter_FU_23_i0_fu_make_oriented_28867_29170_7_8), .in2(out_conv_out_ui_pointer_plus_expr_FU_8_8_8_52_i0_fu_make_oriented_28867_29453_7_8));
  ...
  MUX_GATE #(.BITSIZE_in1(32), .BITSIZE_in2(32), .BITSIZE_out1(32)) MUX_52_reg_9_0_0_1 (.out1(out_MUX_52_reg_9_0_0_1), .sel(selector_MUX_52_reg_9_0_0_1), .in1(out_UUdata_converter_FU_7_i0_fu_make_oriented_28867_29135), .in2(out_MUX_52_reg_9_0_0_0));
  ...
  UUdata_converter_FU #(.BITSIZE_in1(7), .BITSIZE_out1(8)) conv_out_reg_13_reg_13_7_8 (.out1(out_conv_out_reg_13_reg_13_7_8), .in1(out_reg_13_reg_13));
  ...
  UUdata_converter_FU #(.BITSIZE_in1(7), .BITSIZE_out1(8)) conv_out_ui_pointer_plus_expr_FU_8_8_8_52_i0_fu_make_oriented_28867_29453_7_8 (.out1(out_conv_out_ui_pointer_plus_expr_FU_8_8_8_52_i0_fu_make_oriented_28867_29453_7_8), .in1(out_ui_pointer_plus_expr_FU_8_8_8_52_i0_fu_make_oriented_28867_29453));
  ...
  UUdata_converter_FU #(.BITSIZE_in1(32), .BITSIZE_out1(7)) fu_make_oriented_28867_29170 (.out1(out_UUdata_converter_FU_23_i0_fu_make_oriented_28867_29170), .in1(out_reg_9_reg_9));
  ui_plus_expr_FU #(.BITSIZE_in1(32), .BITSIZE_in2(1), .BITSIZE_out1(32)) fu_make_oriented_28867_29178 (.out1(out_ui_plus_expr_FU_32_0_32_50_i0_fu_make_oriented_28867_29178), .in1(out_reg_9_reg_9), .in2(out_const_4));
  ...
  ui_bit_and_expr_FU #(.BITSIZE_in1(1), .BITSIZE_in2(1), .BITSIZE_out1(1)) fu_make_oriented_28867_29226 (.out1(out_ui_bit_and_expr_FU_1_1_1_41_i0_fu_make_oriented_28867_29226), .in1(out_lt_expr_FU_8_0_8_35_i0_fu_make_oriented_28867_29225), .in2(out_reg_16_reg_16));
  ...
  read_cond_FU #(.BITSIZE_in1(1)) fu_make_oriented_28867_29240 (.out1(out_read_cond_FU_29_i0_fu_make_oriented_28867_29240), .in1(out_ge_expr_FU_8_0_8_34_i0_fu_make_oriented_28867_29504));
  ...
  ui_lshift_expr_FU #(.BITSIZE_in1(1), .BITSIZE_in2(1), .BITSIZE_out1(2), .PRECISION(32)) fu_make_oriented_28867_29507 (.out1(out_ui_lshift_expr_FU_8_0_8_47_i0_fu_make_oriented_28867_29507), .in1(out_reg_10_reg_10), .in2(out_const_4));
  UUdata_converter_FU #(.BITSIZE_in1(1), .BITSIZE_out1(1)) fu_make_oriented_28867_29510 (.out1(out_UUdata_converter_FU_14_i0_fu_make_oriented_28867_29510), .in1(out_reg_10_reg_10));
  ...
  ui_bit_and_expr_FU #(.BITSIZE_in1(1), .BITSIZE_in2(1), .BITSIZE_out1(1)) fu_make_oriented_28867_29617 (.out1(out_ui_bit_and_expr_FU_1_0_1_39_i0_fu_make_oriented_28867_29617), .in1(out_reg_10_reg_10), .in2(out_const_4));
  truth_xor_expr_FU #(.BITSIZE_in1(1), .BITSIZE_in2(1), .BITSIZE_out1(1)) fu_make_oriented_28867_29630 (.out1(out_truth_xor_expr_FU_1_1_1_38_i0_fu_make_oriented_28867_29630), .in1(out_reg_8_reg_8), .in2(out_ui_extract_bit_expr_FU_24_i0_fu_make_oriented_28867_29693));
  ...
  ui_rshift_expr_FU #(.BITSIZE_in1(32), .BITSIZE_in2(1), .BITSIZE_out1(31), .PRECISION(32)) fu_make_oriented_28867_29660 (.out1(out_ui_rshift_expr_FU_32_0_32_53_i0_fu_make_oriented_28867_29660), .in1(out_reg_9_reg_9), .in2(out_const_4));
  ...
  ui_bit_and_expr_FU #(.BITSIZE_in1(32), .BITSIZE_in2(1), .BITSIZE_out1(1)) fu_make_oriented_28867_29668 (.out1(out_ui_bit_and_expr_FU_1_0_1_39_i1_fu_make_oriented_28867_29668), .in1(out_reg_9_reg_9), .in2(out_const_4));
  ui_extract_bit_expr_FU #(.BITSIZE_in1(1), .BITSIZE_in2(1)) fu_make_oriented_28867_29693 (.out1(out_ui_extract_bit_expr_FU_24_i0_fu_make_oriented_28867_29693), .in1(out_reg_10_reg_10), .in2(out_const_0));
  ui_extract_bit_expr_FU #(.BITSIZE_in1(1), .BITSIZE_in2(1)) fu_make_oriented_28867_29697 (.out1(out_ui_extract_bit_expr_FU_13_i0_fu_make_oriented_28867_29697), .in1(out_reg_10_reg_10), .in2(out_const_0));
  multi_read_cond_FU #(.BITSIZE_in1(1), .PORTSIZE_in1(2), .BITSIZE_out1(2)) fu_make_oriented_28867_29700 (.out1(out_multi_read_cond_FU_32_i0_fu_make_oriented_28867_29700), .in1({out_reg_17_reg_17, out_reg_15_reg_15}));
  ...
  truth_and_expr_FU #(.BITSIZE_in1(1), .BITSIZE_in2(1), .BITSIZE_out1(1)) fu_make_oriented_28867_29706 (.out1(out_truth_and_expr_FU_1_1_1_36_i0_fu_make_oriented_28867_29706), .in1(out_reg_5_reg_5), .in2(out_truth_not_expr_FU_1_1_37_i0_fu_make_oriented_28867_29703));
  ...
  register_SE #(.BITSIZE_in1(7), .BITSIZE_out1(7)) reg_11 (.out1(out_reg_11_reg_11), .clock(clock), .reset(reset), .in1(out_UUdata_converter_FU_23_i0_fu_make_oriented_28867_29170), .wenable(wrenable_reg_11));
  register_SE #(.BITSIZE_in1(32), .BITSIZE_out1(32)) reg_12 (.out1(out_reg_12_reg_12), .clock(clock), .reset(reset), .in1(out_ui_plus_expr_FU_32_0_32_50_i0_fu_make_oriented_28867_29178), .wenable(wrenable_reg_12));
  register_SE #(.BITSIZE_in1(7), .BITSIZE_out1(7)) reg_13 (.out1(out_reg_13_reg_13), .clock(clock), .reset(reset), .in1(out_ui_pointer_plus_expr_FU_8_8_8_52_i2_fu_make_oriented_28867_29497), .wenable(wrenable_reg_13));
  register_SE #(.BITSIZE_in1(7), .BITSIZE_out1(7)) reg_14 (.out1(out_reg_14_reg_14), .clock(clock), .reset(reset), .in1(out_ui_pointer_plus_expr_FU_8_8_8_52_i3_fu_make_oriented_28867_29519), .wenable(wrenable_reg_14));
  ...
  register_STD #(.BITSIZE_in1(1), .BITSIZE_out1(1)) reg_16 (.out1(out_reg_16_reg_16), .clock(clock), .reset(reset), .in1(out_truth_xor_expr_FU_1_1_1_38_i0_fu_make_oriented_28867_29630), .wenable(wrenable_reg_16));
  register_SE #(.BITSIZE_in1(1), .BITSIZE_out1(1)) reg_17 (.out1(out_reg_17_reg_17), .clock(clock), .reset(reset), .in1(out_truth_and_expr_FU_1_1_1_36_i0_fu_make_oriented_28867_29706), .wenable(wrenable_reg_17));
  register_STD #(.BITSIZE_in1(8), .BITSIZE_out1(8)) reg_18 (.out1(out_reg_18_reg_18), .clock(clock), .reset(reset), .in1(out_UIdata_converter_FU_26_i0_fu_make_oriented_28867_29180), .wenable(wrenable_reg_18));
  ...
  register_STD #(.BITSIZE_in1(7), .BITSIZE_out1(7)) reg_4 (.out1(out_reg_4_reg_4), .clock(clock), .reset(reset), .in1(out_ui_pointer_plus_expr_FU_8_8_8_52_i1_fu_make_oriented_28867_29466), .wenable(wrenable_reg_4));
  ...
  register_SE #(.BITSIZE_in1(1), .BITSIZE_out1(1)) reg_6 (.out1(out_reg_6_reg_6), .clock(clock), .reset(reset), .in1(out_ui_bit_and_expr_FU_1_0_1_40_i0_fu_make_oriented_28867_29644), .wenable(wrenable_reg_6));
  register_SE #(.BITSIZE_in1(1), .BITSIZE_out1(1)) reg_7 (.out1(out_reg_7_reg_7), .clock(clock), .reset(reset), .in1(out_ui_bit_and_expr_FU_1_0_1_40_i1_fu_make_oriented_28867_29656), .wenable(wrenable_reg_7));
  register_SE #(.BITSIZE_in1(1), .BITSIZE_out1(1)) reg_8 (.out1(out_reg_8_reg_8), .clock(clock), .reset(reset), .in1(out_ui_extract_bit_expr_FU_13_i0_fu_make_oriented_28867_29697), .wenable(wrenable_reg_8));
